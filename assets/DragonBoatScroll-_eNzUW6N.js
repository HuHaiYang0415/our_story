...
想你的小胡
二零二六 五月初五`},b1=r1.content.split(/\n\n+/).map(n=>n.trim()).filter(Boolean),Q=[{id:"prologue",material:"dawn",chapter:"壹",sceneLabel:"引 · 展卷",layout:"center",displayMode:"vertical-pair",display:"蒲节记胜",subtitle:"二零二六 · 端午长卷",body:["岁序走到重五，江风先热起来了"],forwardTransition:"morph-ink",eggs:[{id:"egg-prologue-hint",anchor:"top-right",text:"岁时记",reveal:"想和你一起过端午"}]},{id:"river",material:"river",chapter:"贰",sceneLabel:"江 · 远眺",layout:"river-glyph",displayMode:"horizontal",display:"江",subtitle:"天",body:["风从江面来，带着菖蒲与糯米的香气","南风知我意，流水寄相思"],bodyVariant:"asymmetric",forwardTransition:"morph-jiang",eggs:[{id:"egg-river-mist",anchor:"mid-left",text:"夹注 · 瓯江",hint:!0,reveal:"五叩粼粼江浪，自来一纸瓶笺"}]},{id:"race",material:"race",chapter:"叁",sceneLabel:"渡 · 鼓震",layout:"race-diagonal",displayMode:"horizontal",display:"渡",subtitle:"鼓声逐浪，心意同频",body:["三舟并渡，各怀节奏"],bodyVariant:"asymmetric",forwardTransition:"morph-boat",eggs:[{id:"egg-race-drum",anchor:"bottom-right",text:"鼓点三下",hint:!0,reveal:"三声鼓鸣，致我满心歉意"}]},{id:"festive",material:"festive",chapter:"肆",sceneLabel:"物 · 案上",layout:"festive-split",displayMode:"horizontal",display:"节物",subtitle:"案上岁时，掌上温良",body:["糯米裹成三角，咸甜各安其味","门悬艾蒲，兰汤祓禊，皆为长夏祈福","江上的热闹归于案头，想把满心温柔尽数写进书卷"],bodyVariant:"asymmetric",forwardTransition:"morph-zongzi-seal",eggs:[{id:"egg-festive-ai",anchor:"top-left",text:"艾",reveal:"艾香一缕，祝君温良无疾"},{id:"egg-festive-zong",anchor:"bottom-left",text:"粽",reveal:"一口糯香...算了不好消化，我们吃冰淇淋吧"}]},{id:"letter",material:"paper",chapter:"伍",sceneLabel:"寄情 · 展信",layout:"center",displayMode:"horizontal",display:r1.title,body:b1.length>0?b1:[r1.content],bodyVariant:"letter",eggs:[{id:"egg-letter-seal",anchor:"top-right",text:"印",reveal:"平生不会相思，才会相思，便害相思"}]},{id:"finale",material:"finale",chapter:"陆",sceneLabel:"收 · 记胜",layout:"center",displayMode:"finale",display:"永远「粽」意你",subtitle:"第一个端午节",body:["糯米成粽 艾菖辟邪 心心相扣 不负岁时韶华"],eggs:[{id:"egg-finale-story",anchor:"bottom-right",text:"Our Story",reveal:"日日念你 · 岁岁有你"}]}],t2=Q.length;function l2(n,t){var i;if(t!==n+1)return null;const e=(i=Q[n])==null?void 0:i.forwardTransition;return e==="morph-ink"||e==="morph-jiang"||e==="morph-boat"||e==="morph-zongzi-seal"?e:null}const T1=[.22,1,.36,1];function F1({char:n,index:t,reduceMotion:e,className:i}){return n===" "||n===`
`?a.jsx("span",{className:"inline-block w-[0.35em]","aria-hidden":!0}):e?a.jsx("span",{className:i,children:n}):a.jsx(m.span,{className:`db-ink-char inline-block ${i??""}`,style:{transformOrigin:"50% 100%",transformPerspective:600},initial:{opacity:0,y:36,rotateX:-52,filter:"blur(10px)"},animate:{opacity:1,y:0,rotateX:0,filter:"blur(0px)"},transition:{delay:.08+t*.07,duration:.62,ease:T1},children:n})}function e2({text:n,onDark:t,className:e}){const i=S(),l=[...n];return a.jsx("h2",{className:["db-ink-display db-ink-display--hero",t?"db-ink-display--on-dark":"db-ink-display--on-light",e].filter(Boolean).join(" "),"aria-label":n,children:l.map((c,d)=>a.jsx(F1,{char:c,index:d,reduceMotion:!!i},`${c}-${d}`))})}function i2({text:n,onDark:t}){const e=S(),i=Math.ceil(n.length/2),l=n.slice(0,i),c=n.slice(i);return a.jsx("div",{className:"db-ink-vertical-pair","aria-label":n,children:[l,c].map((d,h)=>a.jsx("div",{className:"db-ink-vertical-row",children:[...d].map((p,o)=>a.jsx(F1,{char:p,index:h*4+o,reduceMotion:!!e,className:t?"db-ink-display--on-dark":"db-ink-display--on-light"},`${h}-${p}-${o}`))},h))})}function c2({onDark:n}){const t=S(),e=["永","远","「","粽","」","意","你"];let i=0;return a.jsx("h2",{className:["db-ink-display db-ink-display--finale",n?"db-ink-display--on-dark":"db-ink-display--on-light"].join(" "),"aria-label":"永远粽意你",children:e.map(l=>{const c=i++,d=l==="粽";return t?a.jsx("span",{className:d?"db-zong-accent":void 0,children:l},l+c):a.jsx(m.span,{className:`db-ink-char inline-block ${d?"db-zong-accent":""}`,style:{transformOrigin:"50% 100%"},initial:{opacity:0,y:28,scale:d?.5:.85,filter:"blur(8px)"},animate:{opacity:1,y:0,scale:1,filter:"blur(0px)"},transition:{delay:.1+c*.09,duration:d?.75:.55,ease:T1},children:l},l+c)})})}function s2({text:n,mode:t="horizontal",onDark:e,className:i}){return t==="finale"?a.jsx(c2,{onDark:e}):t==="vertical-pair"?a.jsx(i2,{text:n,onDark:e}):a.jsx(e2,{text:n,onDark:e,className:i})}const p1=[.22,1,.36,1];function d2({text:n,onDark:t,delay:e=.42}){const i=S();return a.jsxs("div",{className:"db-ink-subtitle-wrap",children:[a.jsx(m.p,{className:["db-ink-subtitle",t?"text-stone-300":"text-stone-600"].join(" "),initial:i?{}:{opacity:0,y:14,letterSpacing:"0.2em"},animate:{opacity:1,y:0,letterSpacing:"0.08em"},transition:{delay:i?0:e,duration:.55,ease:p1},children:n}),a.jsx(m.div,{className:t?"db-ink-rule db-ink-rule--light":"db-ink-rule db-ink-rule--dark",initial:i?{scaleX:1}:{scaleX:0},animate:{scaleX:1},transition:{delay:i?0:e+.12,duration:.65,ease:p1},"aria-hidden":!0})]})}function f1({lines:n,onDark:t,variant:e="center",baseDelay:i=.52,exiting:l=!1,exitBaseDelay:c=0}){const d=S(),h=e==="letter",p=e==="asymmetric";return a.jsx("div",{className:["db-stagger-lines",h?"db-stagger-lines--letter":"",p?"db-stagger-lines--asymmetric":""].filter(Boolean).join(" "),children:n.map((o,y)=>{const u=h&&y===0,r=h&&y===n.length-1&&n.length>1;return a.jsx(m.p,{className:["db-stagger-line",t?"text-stone-200/95":"text-stone-700",h?"db-stagger-line--letter":"",u?"db-stagger-line--letter-salute":"",r?"db-stagger-line--letter-sign":""].join(" "),initial:d||l?!1:{opacity:0,x:h?24:p?-16:0,y:h?0:18,filter:"blur(5px)"},animate:l?{opacity:0,x:p?12:0,y:20,filter:"blur(6px)"}:{opacity:1,x:0,y:0,filter:"blur(0px)"},transition:l?{delay:d?0:c+y*.08,duration:.52,ease:[.4,0,.2,1]}:{delay:d?0:i+y*.14,duration:.58,ease:p1},children:o},`${o}-${y}`)})})}function h2({chapter:n,sceneLabel:t,onDark:e}){const i=S();return a.jsxs(a.Fragment,{children:[a.jsxs(m.div,{className:["db-scroll-frame",e?"db-scroll-frame--dark":"db-scroll-frame--light"].join(" "),initial:i?{}:{opacity:0},animate:{opacity:1},transition:{delay:.05,duration:.4},"aria-hidden":!0,children:[a.jsx("span",{className:"db-scroll-frame-corner db-scroll-frame-corner--tl"}),a.jsx("span",{className:"db-scroll-frame-corner db-scroll-frame-corner--tr"}),a.jsx("span",{className:"db-scroll-frame-corner db-scroll-frame-corner--bl"}),a.jsx("span",{className:"db-scroll-frame-corner db-scroll-frame-corner--br"})]}),a.jsx(m.div,{className:"db-scroll-chapter-mark",initial:i?{}:{opacity:0,x:-8},animate:{opacity:.22,x:0},transition:{delay:.2,duration:.5},"aria-hidden":!0,children:n}),a.jsx(m.p,{className:["db-scroll-scene-label",e?"text-stone-400/60":"text-stone-500/55"].join(" "),initial:i?{}:{opacity:0},animate:{opacity:1},transition:{delay:.55,duration:.45},children:t})]})}function g1(n){return n?"linear-gradient(180deg, transparent 0%, rgba(15,42,34,0.08) 18%, rgba(6,78,59,0.22) 48%, rgba(2,44,29,0.38) 78%, rgba(2,44,29,0.48) 100%)":"linear-gradient(180deg, transparent 0%, rgba(214,230,222,0.22) 22%, rgba(152,181,168,0.32) 52%, rgba(74,100,88,0.28) 82%, rgba(74,100,88,0.36) 100%)"}function r2(n){return n?"radial-gradient(ellipse 70% 65% at 50% 55%, rgba(180,120,70,0.42) 0%, rgba(90,55,30,0.18) 42%, transparent 72%)":"radial-gradient(ellipse 70% 65% at 50% 55%, rgba(210,165,105,0.38) 0%, rgba(160,110,65,0.16) 40%, transparent 72%)"}const t1=820,p2=Math.round(t1*.68),A1=t1/1e3,x1=[.38,.02,.18,1],K=880,f2=Math.round(K*.72),a1=1050,o1=680,o2=Math.round(o1*.7),y2=[t1,K,a1,o1],u2=14,C1=18;function M2({className:n,isNight:t=!1,onWaterTap:e,interactive:i=!0}){const[l,c]=s.useState([]),d=s.useRef(0),h=s.useRef(null),p=s.useRef(null),o=s.useCallback((f,b,k)=>{const j=h.current;if(!j)return;const Z=j.getBoundingClientRect(),A=(f-Z.left)/Z.width*100,x=(b-Z.top)/Z.height*100,v=++d.current;c(T=>[...T.slice(-9),{id:v,x:A,y:x}]),k&&(e==null||e({x:A,y:x})),window.setTimeout(()=>{c(T=>T.filter(D=>D.id!==v))},1400)},[e]),y=f=>{i&&(p.current={startX:f.clientX,startY:f.clientY,maxMove:0,lastRippleX:f.clientX,lastRippleY:f.clientY},f.currentTarget.setPointerCapture(f.pointerId))},u=f=>{if(!i)return;const b=p.current;if(!b||f.buttons===0&&f.pressure===0)return;const k=f.clientX-b.startX,j=f.clientY-b.startY;b.maxMove=Math.max(b.maxMove,Math.hypot(k,j));const Z=f.clientX-b.lastRippleX,A=f.clientY-b.lastRippleY;Z*Z+A*A<C1*C1||(b.lastRippleX=f.clientX,b.lastRippleY=f.clientY,o(f.clientX,f.clientY,!1))},r=f=>{if(!i)return;const b=p.current;p.current=null,f.currentTarget.hasPointerCapture(f.pointerId)&&f.currentTarget.releasePointerCapture(f.pointerId),b&&b.maxMove<=u2&&o(f.clientX,f.clientY,!0)},g=f=>r(f),M=f=>r(f);return a.jsx("div",{ref:h,className:["db-river-ripple-surface",t?"db-river-ripple-surface--night":"db-river-ripple-surface--day",n].filter(Boolean).join(" "),onPointerDown:y,onPointerMove:u,onPointerUp:g,onPointerCancel:M,"aria-hidden":i?void 0:!0,children:l.map(f=>a.jsx("span",{className:"db-river-ripple",style:{left:`${f.x}%`,top:`${f.y}%`}},f.id))})}var N1=W1();const Z2=`我猜这个彩蛋你发现不了，所以偷偷记录一点放肆的话。
超级超级喜欢你！
每天都很想见你！
真的很希望我能让你喜欢
总之我会努力做的更好的
希望正式和你在一起的那一天不太遥远`,m2=5,E=-28,b2="dragon-boat-scroll-root";function g2(){return document.getElementById(b2)??document.body}function v1({isNight:n,submerged:t=!1}){const e=t?n?"rgba(6, 78, 59, 0.35)":"rgba(16, 120, 90, 0.32)":n?"rgba(134, 239, 172, 0.28)":"rgba(167, 243, 208, 0.48)",i=t?n?"rgba(2, 44, 34, 0.72)":"rgba(4, 72, 55, 0.58)":n?"rgba(6, 78, 59, 0.58)":"rgba(52, 211, 153, 0.32)",l=t?n?"rgba(94, 234, 212, 0.28)":"rgba(167, 243, 208, 0.35)":n?"rgba(167, 243, 208, 0.62)":"rgba(255, 255, 255, 0.78)";return a.jsxs("svg",{className:"db-drift-bottle-svg",viewBox:"0 0 64 104",fill:"none",xmlns:"http://www.w3.org/2000/svg","aria-hidden":!0,children:[a.jsx("path",{d:"M32 37 C17.5 37 13.5 54 13.5 72.5 C13.5 89 19.5 97 32 97 C44.5 97 50.5 89 50.5 72.5 C50.5 54 46.5 37 32 37Z",fill:i,stroke:l,strokeWidth:"1.2"}),a.jsx("path",{d:"M32 37 C22 37 18 50 18 68 C18 82 22 90 32 90 C42 90 46 82 46 68 C46 50 42 37 32 37Z",fill:e}),a.jsx("path",{d:"M26.5 37 L26.5 17.5 C26.5 13.5 28.5 11.5 32 11.5 C35.5 11.5 37.5 13.5 37.5 17.5 L37.5 37",fill:i,stroke:l,strokeWidth:"1"}),!t&&a.jsxs(a.Fragment,{children:[a.jsx("rect",{x:"24.5",y:"3.5",width:"15",height:"9.5",rx:"2.5",fill:"#c9a66b",stroke:"#8b6914",strokeWidth:"0.8"}),a.jsx("rect",{x:"23",y:"2",width:"18",height:"3",rx:"1.2",fill:"#a8844a"})]}),t&&a.jsx("rect",{x:"24.5",y:"3.5",width:"15",height:"9.5",rx:"2.5",fill:"#7a6344",stroke:"#4a3818",strokeWidth:"0.8",opacity:"0.55"}),a.jsx("rect",{x:"22",y:"54",width:"20",height:"26",rx:"1.5",fill:t?"#d4c4a0":"#fef3c7",stroke:"#d6c4a0",strokeWidth:"0.6",transform:"rotate(-10 32 67)",opacity:t?.55:.92}),!t&&a.jsx("path",{d:"M24 58 L28 56 L30 78 L26 80Z",fill:"#fde68a",opacity:"0.5",transform:"rotate(-10 32 67)"}),!t&&a.jsx("path",{d:"M21 48 Q19 70 23 88",stroke:"rgba(255,255,255,0.42)",strokeWidth:"1.8",strokeLinecap:"round"}),!t&&a.jsx("path",{d:"M28 14 C30 15 34 15 36 14",stroke:"#8b6914",strokeWidth:"0.8",strokeLinecap:"round",opacity:"0.6"})]})}function A2({isNight:n}){return a.jsxs("span",{className:"db-drift-bottle-figure","aria-hidden":!0,children:[a.jsx("span",{className:"db-drift-bottle-half db-drift-bottle-half--below",children:a.jsx(v1,{isNight:n,submerged:!0})}),a.jsx("span",{className:"db-drift-bottle-surface-line"}),a.jsx("span",{className:"db-drift-bottle-half db-drift-bottle-half--above",children:a.jsx(v1,{isNight:n})})]})}function x2({spot:n,phase:t,isNight:e=!1,onBottleClick:i,onClosePaper:l,onRiseComplete:c,onSinkComplete:d}){const h=S();if(s.useEffect(()=>{if(t!=="rising")return;if(h){c();return}const r=window.setTimeout(c,780);return()=>window.clearTimeout(r)},[t,h,c]),s.useEffect(()=>{t!=="sinking"||!h||d()},[t,h,d]),!n||t==="hidden")return null;const p={left:`${n.x}%`,top:`${n.y}%`},o=t==="rising"||t==="floating"||t==="sinking",y=t==="paper",u=typeof document<"u"?N1.createPortal(a.jsx(W,{children:y&&a.jsxs(a.Fragment,{children:[a.jsx(m.button,{type:"button",className:"db-drift-bottle-backdrop",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:l,"aria-label":"收起纸团"},"drift-bottle-backdrop"),a.jsxs(m.div,{className:"db-drift-bottle-paper",role:"dialog","aria-modal":"true","aria-labelledby":"drift-bottle-paper-text",initial:h?{opacity:1,scale:1,x:"-50%",y:"-50%"}:{opacity:0,scale:.88,x:"-50%",y:"calc(-50% + 12px)"},animate:{opacity:1,scale:1,x:"-50%",y:"-50%"},exit:{opacity:0,scale:.92,x:"-50%",y:"calc(-50% + 8px)"},transition:{duration:.42,ease:[.22,1,.36,1]},children:[a.jsx("div",{className:"db-drift-bottle-paper-body",children:a.jsx("p",{id:"drift-bottle-paper-text",className:"db-drift-bottle-paper-text",children:Z2})}),a.jsx("button",{type:"button",className:"db-drift-bottle-paper-close",onClick:l,children:"收起"})]},"drift-bottle-paper")]})}),g2()):null;return a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-drift-bottle-layer",style:p,children:a.jsx(W,{mode:"wait",children:o&&a.jsxs(m.button,{type:"button",className:"db-drift-bottle",initial:h?{opacity:1,y:0,scale:1,rotate:E}:{opacity:0,y:28,scale:.82,rotate:E-6},animate:t==="sinking"?{opacity:0,y:36,scale:.65,rotate:E+10}:t==="rising"?{opacity:1,y:0,scale:1,rotate:E}:{opacity:1,y:[0,-3,0],scale:1,rotate:[E+2,E-2,E+2]},exit:{opacity:0,y:32,scale:.6,rotate:E+8},style:{transformOrigin:"50% 50%"},transition:t==="sinking"?{duration:.85,ease:[.45,.05,.55,.95]}:t==="rising"?{duration:.75,ease:[.22,1,.36,1]}:{y:{duration:2.8,repeat:1/0,ease:"easeInOut"},rotate:{duration:3.2,repeat:1/0,ease:"easeInOut"}},onAnimationComplete:()=>{t==="sinking"&&!h&&d()},onClick:r=>{t==="floating"&&(r.stopPropagation(),i())},disabled:t!=="floating","aria-label":"拾取漂流瓶",children:[a.jsx("span",{className:"db-drift-bottle-ring","aria-hidden":!0}),a.jsx(A2,{isNight:e})]},"bottle")})}),u]})}const C2=""+new URL("drums-BnD5tEc6.mp3",import.meta.url).href,v2=5e3;class w2{constructor(){this.ctx=null,this.isMuted=!1,this.bgmAudio=null,this.drumAudio=null,this.bgmIntervalId=null,this.bgmRestartTimer=null,this.bgmEndedHandler=null,this.bgmCanPlayHandler=null,this.ambientSrc=null}initContext(){var t;if(!this.ctx){const e=window.AudioContext||window.webkitAudioContext;e&&(this.ctx=new e)}((t=this.ctx)==null?void 0:t.state)==="suspended"&&this.ctx.resume()}setMuted(t){this.isMuted=t,t?this.stopAmbient():this.startAmbient()}getMuted(){return this.isMuted}setAmbientSrc(t){this.ambientSrc!==t&&(this.clearBgmAudio(),this.ambientSrc=t,t&&this.prefetchAmbient(t))}prefetchAmbient(t){const e=new Audio;e.preload="auto",e.volume=.22,e.loop=!1,this.bgmEndedHandler=()=>{this.isMuted||!this.ambientSrc||(this.clearBgmRestartTimer(),this.bgmRestartTimer=setTimeout(()=>{this.bgmRestartTimer=null,!(this.isMuted||!this.bgmAudio)&&(this.bgmAudio.currentTime=0,this.bgmAudio.play().catch(()=>{}))},v2))},e.addEventListener("ended",this.bgmEndedHandler),e.src=t,this.bgmAudio=e}tryPlayAmbient(){const t=this.bgmAudio;if(!t||this.isMuted)return;this.bgmCanPlayHandler&&(t.removeEventListener("canplay",this.bgmCanPlayHandler),this.bgmCanPlayHandler=null);const e=()=>{this.isMuted||!this.bgmAudio||this.bgmAudio.play().catch(()=>{})};t.readyState>=HTMLMediaElement.HAVE_FUTURE_DATA?e():(this.bgmCanPlayHandler=e,t.addEventListener("canplay",e,{once:!0}))}clearBgmRestartTimer(){this.bgmRestartTimer&&(clearTimeout(this.bgmRestartTimer),this.bgmRestartTimer=null)}clearBgmAudio(){this.clearBgmRestartTimer(),this.bgmAudio&&(this.bgmEndedHandler&&this.bgmAudio.removeEventListener("ended",this.bgmEndedHandler),this.bgmCanPlayHandler&&this.bgmAudio.removeEventListener("canplay",this.bgmCanPlayHandler),V1(this.bgmAudio)),this.bgmEndedHandler=null,this.bgmCanPlayHandler=null,this.bgmAudio=null}ensureBgmAudio(){return this.ambientSrc?this.bgmAudio?this.bgmAudio:(this.prefetchAmbient(this.ambientSrc),this.bgmAudio):null}tone(t,e,i="sine",l=.08,c=0){if(this.isMuted||!this.ctx)return;const d=this.ctx.currentTime+c,h=this.ctx.createOscillator(),p=this.ctx.createGain();h.type=i,h.frequency.setValueAtTime(t,d),p.gain.setValueAtTime(0,d),p.gain.linearRampToValueAtTime(l,d+.02),p.gain.exponentialRampToValueAtTime(.001,d+e),h.connect(p),p.connect(this.ctx.destination),h.start(d),h.stop(d+e+.05)}noiseBurst(t,e=.04,i=800,l=0){if(this.isMuted||!this.ctx)return;const c=this.ctx.currentTime+l,d=Math.floor(this.ctx.sampleRate*t),h=this.ctx.createBuffer(1,d,this.ctx.sampleRate),p=h.getChannelData(0);for(let r=0;r<d;r++)p[r]=(Math.random()*2-1)*(1-r/d);const o=this.ctx.createBufferSource();o.buffer=h;const y=this.ctx.createBiquadFilter();y.type="lowpass",y.frequency.setValueAtTime(i,c);const u=this.ctx.createGain();u.gain.setValueAtTime(e,c),u.gain.exponentialRampToValueAtTime(.001,c+t),o.connect(y),y.connect(u),u.connect(this.ctx.destination),o.start(c),o.stop(c+t)}ensureReady(){this.isMuted||(this.initContext(),this.startAmbient())}playUnroll(){this.isMuted||(this.initContext(),this.noiseBurst(.35,.035,1200),this.tone(180,.25,"triangle",.05),this.tone(120,.4,"sine",.03,.08))}playMorphWater(){this.isMuted||(this.initContext(),this.noiseBurst(.55,.05,600),this.tone(220,.3,"sine",.04),this.tone(165,.45,"triangle",.03,.12))}playMorphDrum(){this.isMuted||(this.initContext(),[0,.18,.36].forEach(t=>{this.tone(90,.12,"sine",.1,t),this.noiseBurst(.08,.025,400,t)}))}playMorphInk(){this.isMuted||(this.initContext(),this.noiseBurst(.5,.03,300),this.tone(80,.6,"triangle",.06))}playMorphSeal(){this.isMuted||(this.initContext(),this.tone(440,.08,"sine",.06),this.tone(330,.15,"triangle",.05,.06),this.noiseBurst(.12,.02,2e3,.1))}playRaceDrum(){if(this.isMuted)return;this.initContext(),this.drumAudio||(this.drumAudio=new Audio(C2),this.drumAudio.volume=.62);const t=this.drumAudio.cloneNode(!0);t.volume=this.drumAudio.volume,t.play().catch(()=>{})}playEggTap(){this.isMuted||(this.initContext(),this.tone(520,.06,"sine",.07),this.tone(780,.1,"triangle",.04,.04))}playLetterOpen(){this.isMuted||(this.initContext(),this.noiseBurst(.2,.03,1500),this.tone(260,.2,"sine",.05),this.tone(196,.35,"triangle",.03,.1))}playSynthAmbientNote(t,e,i){if(this.isMuted||!this.ctx)return;const l=this.ctx.currentTime+i,c=this.ctx.createOscillator(),d=this.ctx.createGain();c.type="sine",c.frequency.setValueAtTime(t,l),d.gain.setValueAtTime(0,l),d.gain.linearRampToValueAtTime(.018,l+.15),d.gain.exponentialRampToValueAtTime(.001,l+e),c.connect(d),d.connect(this.ctx.destination),c.start(l),c.stop(l+e)}startAmbient(){if(this.isMuted)return;if(this.initContext(),this.ambientSrc){this.ensureBgmAudio(),this.tryPlayAmbient();return}if(this.bgmIntervalId||!this.ctx)return;const t=[261.63,293.66,329.63,392,440];let e=0;const i=()=>{if(!(!this.ctx||this.isMuted)){for(let l=0;l<3;l++){const c=t[(e+l)%t.length];this.playSynthAmbientNote(c,2.8,l*1.4)}e=(e+3)%t.length}};i(),this.bgmIntervalId=setInterval(i,4200)}stopAmbient(){this.bgmIntervalId&&(clearInterval(this.bgmIntervalId),this.bgmIntervalId=null),this.clearBgmRestartTimer(),this.bgmAudio&&(this.bgmAudio.pause(),this.bgmAudio.currentTime=0)}dispose(){var t;this.stopAmbient(),this.clearBgmAudio(),this.ambientSrc=null,(t=this.ctx)==null||t.close(),this.ctx=null}}const R=new w2;function l1({children:n,className:t,variant:e="stack"}){return a.jsx("div",{className:["db-scene-layout",`db-scene-layout--${e}`,t].filter(Boolean).join(" "),children:n})}function S2({beat:n,onDark:t,isNight:e,isExitingMorph:i=!1,onMorphComplete:l}){const c=S(),d=s.useRef(!1),[,h]=s.useState(0),[p,o]=s.useState(null),[y,u]=s.useState("hidden"),[r,g]=s.useState(!1),M=s.useCallback(()=>{!i||d.current||(d.current=!0,l==null||l())},[i,l]);s.useEffect(()=>{if(!i){d.current=!1;return}if(c){M();return}const x=window.setTimeout(M,p2),v=window.setTimeout(M,t1+80);return()=>{window.clearTimeout(x),window.clearTimeout(v)}},[i,c,M]);const f=!i&&!r&&y==="hidden",b=s.useCallback(x=>{f&&h(v=>{const T=v+1;return T>=m2&&(o(x),u("rising")),T})},[f]),k=s.useCallback(()=>{u(x=>x==="rising"?"floating":x)},[]),j=s.useCallback(()=>{u("paper"),R.playEggTap()},[]),Z=s.useCallback(()=>{u("sinking")},[]),A=s.useCallback(()=>{u("hidden"),o(null),g(!0)},[]);return a.jsxs(l1,{className:"db-layout-river-glyph",variant:"stack",children:[a.jsxs("div",{className:"db-layout-river-glyph-water",children:[a.jsx(M2,{className:"db-layout-river-glyph-ripples",isNight:e,onWaterTap:b,interactive:f}),a.jsx(x2,{spot:p,phase:y,isNight:e,onBottleClick:j,onClosePaper:Z,onRiseComplete:k,onSinkComplete:A})]}),a.jsxs("div",{className:"db-layout-river-glyph-hero",children:[a.jsx("h2",{className:["db-river-glyph-main",t?"db-ink-display--on-dark":""].join(" "),"aria-label":"江天",children:a.jsx(m.span,{className:"db-river-glyph-char",style:{transformOrigin:"50% 0%"},initial:c?!1:{opacity:0,y:"40%",scaleY:1.6,scaleX:.85,filter:"blur(8px)"},animate:i?{opacity:0,y:"120%",scaleY:2.3,scaleX:.7,filter:"blur(0px)"}:{opacity:1,y:0,scaleY:1,scaleX:1,filter:"blur(0px)"},transition:i?{duration:A1,ease:x1,delay:0}:{duration:.75,ease:[.22,1,.36,1]},children:"江"})}),n.subtitle&&a.jsx(m.span,{className:"db-river-glyph-corner",initial:c?!1:{opacity:0,y:-8},animate:i?{opacity:0,y:-14,scaleY:1.35,scaleX:.88}:{opacity:.75,y:0,scaleY:1,scaleX:1},transition:i?{duration:.42,delay:.04,ease:x1}:{delay:.42,duration:.45,ease:[.22,1,.36,1]},style:{transformOrigin:"50% 0%"},children:n.subtitle})]}),n.body&&n.body.length>0&&a.jsx("div",{className:"db-layout-river-glyph-body",children:a.jsx(f1,{lines:n.body,onDark:t,variant:"asymmetric",exiting:i,exitBaseDelay:0})}),a.jsx(m.div,{className:"db-layout-river-glyph-wave",style:{background:g1(e)},"aria-hidden":!0,initial:!1,animate:i?{opacity:0,x:"0%"}:{opacity:1,x:["-2%","2%","-2%"]},transition:i?{duration:.38,ease:[.4,0,.2,1]}:{duration:10,repeat:1/0,ease:"easeInOut"}}),i&&a.jsx(m.div,{className:"db-layout-river-glyph-wash",style:{background:g1(e)},initial:{opacity:0,scaleY:.35},animate:{opacity:.82,scaleY:1},transition:{duration:A1*.85,delay:.08,ease:[.32,.72,0,1]},"aria-hidden":!0})]})}const j2=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   viewBox="0 0 750 500"
   version="1.1"
   id="svg289"
...
`,T2=j2,F2=k2,N2=R2,L2={3:T2,2:F2,1:N2};function L1({index:n,label:t="近舟",isNight:e,showLabel:i=!1,morphLite:l=!1,rowBurst:c=!1,hitTargetRef:d}){const h=L2[n],p=n===1?"0.9s":"1.15s",o=n===1?"0.6s":"0.77s",y=c?"0.28s":"0.55s",u=c?o:p,r=`
  ...
  `,g=a.jsx("div",{ref:d,className:`db-boat-svg-hit-target pointer-events-none flex h-full w-full items-center justify-end [&>svg]:h-full [&>svg]:w-full [&>svg]:overflow-visible ${e?"brightness-110":""}`,dangerouslySetInnerHTML:{__html:h}});return a.jsxs("div",{className:[`relative flex h-full w-full flex-col items-center justify-end boat-container-${n}`,l?"boat-container--lite":"",c?"boat-container--row-burst":""].filter(Boolean).join(" "),style:{"--row-duration":u,"--drum-duration":y},children:[a.jsx("style",{children:r}),i&&a.jsx("span",{className:"pointer-events-none absolute -top-4 select-none rounded border border-amber-900/30 bg-black/45 px-1 py-0.5 font-serif text-[7px] text-amber-200",children:t}),l?g:a.jsx(m.div,{className:"pointer-events-none h-full w-full",animate:{y:[-1,1,-1],rotate:[-.4,.4,-.4]},transition:{duration:n===1?.95:1.25,repeat:1/0,ease:"easeInOut"},children:g})]})}function H2(n){const i=(n.querySelector("svg")??n).getBoundingClientRect();return i.width<4||i.height<4?null:{left:i.left,top:i.top,width:i.width,height:i.height}}function q2({hitTargetRef:n,onTap:t,disabled:e=!1,isNight:i=!1}){const[l,c]=s.useState(null),[d,h]=s.useState([]),p=s.useRef(null),o=s.useRef(0),y=s.useRef(0),[u,r]=s.useState(null);s.useEffect(()=>{r(document.getElementById("dragon-boat-scroll-root"))},[]);const g=()=>{const Z=n.current;if(!Z||e){c(null);return}c(H2(Z))};s.useLayoutEffect(()=>{if(g(),e)return;const Z=n.current,A=Z?new ResizeObserver(g):null;A==null||A.observe(Z);let x=0;const v=()=>{g(),x=requestAnimationFrame(v)};return x=requestAnimationFrame(v),window.addEventListener("resize",g),()=>{A==null||A.disconnect(),cancelAnimationFrame(x),window.removeEventListener("resize",g)}},[n,e]);const M=(Z,A)=>{const x=++y.current;h(v=>[...v.slice(-5),{id:x,x:Z,y:A}]),window.setTimeout(()=>{h(v=>v.filter(T=>T.id!==x))},950)},f=(Z,A)=>{const x=Date.now();x-o.current<100||(o.current=x,M(Z,A),t())},b=Z=>{p.current={x:Z.clientX,y:Z.clientY},Z.stopPropagation()},k=Z=>{Z.stopPropagation();const A=p.current;if(p.current=null,!A)return;const x=Z.clientX-A.x,v=Z.clientY-A.y;Math.hypot(x,v)>18||f(Z.clientX,Z.clientY)};if(e||!u||!l)return null;const j=i?"db-race-drum-wave--night":"db-race-drum-wave--day";return N1.createPortal(a.jsxs(a.Fragment,{children:[d.map(Z=>a.jsxs("span",{className:["db-race-drum-wave",j].join(" "),style:{left:Z.x,top:Z.y},"aria-hidden":!0,children:[a.jsx("span",{className:"db-race-drum-wave__ring"}),a.jsx("span",{className:"db-race-drum-wave__ring db-race-drum-wave__ring--delay-1"}),a.jsx("span",{className:"db-race-drum-wave__ring db-race-drum-wave__ring--delay-2"})]},Z.id)),a.jsx("button",{type:"button",className:"db-race-drum-hit db-race-drum-hit--portal",style:{position:"fixed",left:l.left,top:l.top,width:l.width,height:l.height},onPointerDown:b,onPointerUp:k,"aria-label":"敲鼓"})]}),u)}const i1=5e3,w1=1.35,c1=.9,n1=1200,O=[{segments:["临时加了这个part，","也是为我最近不好的状态说声抱歉"],partGaps:[0,880],startOffset:0,fadeStagger:0,placement:{left:"6%",top:"48%",maxWidth:"min(78vw, 17.5rem)",rotate:-2.1,textAlign:"left"}},{segments:["很抱歉最近事情很多，","连开假条的时间都忘了"],partGaps:[0,720],startOffset:2900,fadeStagger:820,placement:{right:"7%",top:"57%",maxWidth:"min(72vw, 16rem)",rotate:1.6,textAlign:"right",transformOrigin:"100% 50%"}},{segments:["在你情绪不好的时候，没能给你一些依靠"],partGaps:[0],startOffset:5400,fadeStagger:1680,placement:{left:"11%",top:"66%",maxWidth:"min(70vw, 15.5rem)",rotate:-.9,textAlign:"left"}},{segments:["我还不够细心周到，","但我会不断努力的"],partGaps:[0,1040],startOffset:7600,fadeStagger:2540,placement:{left:"19%",top:"76%",maxWidth:"min(68vw, 15rem)",rotate:1.3,textAlign:"left"}}];function _2({active:n,isNight:t}){const e=S(),[i,l]=s.useState(()=>O.map(()=>({visibleParts:0,fading:!1,gone:!1}))),c=s.useRef(0);return s.useEffect(()=>{if(!n){c.current+=1,l(O.map(()=>({visibleParts:0,fading:!1,gone:!1})));return}const d=c.current+1;c.current=d;const h=[],p=(r,g)=>{c.current===d&&l(M=>M.map((f,b)=>b===r?{...f,...g}:f))};if(e)return h.push(window.setTimeout(()=>{l(O.map(r=>({visibleParts:r.segments.length,fading:!1,gone:!1})))},n1)),h.push(window.setTimeout(()=>{O.forEach((r,g)=>p(g,{fading:!0}))},n1+i1)),h.push(window.setTimeout(()=>{O.forEach((r,g)=>p(g,{gone:!0,visibleParts:0}))},n1+i1+c1*1e3)),()=>h.forEach(r=>window.clearTimeout(r));const o=[];O.forEach((r,g)=>{let M=n1+r.startOffset;r.segments.forEach((f,b)=>{b>0&&(M+=r.partGaps[b]??800),h.push(window.setTimeout(()=>{p(g,{visibleParts:b+1,fading:!1,gone:!1})},M))}),o.push(M+w1*1e3)});const u=Math.max(...o)+i1;return O.forEach((r,g)=>{const M=u+r.fadeStagger;h.push(window.setTimeout(()=>{p(g,{fading:!0})},M)),h.push(window.setTimeout(()=>{p(g,{fading:!1,gone:!0,visibleParts:0})},M+c1*1e3))}),()=>h.forEach(r=>window.clearTimeout(r))},[n,e]),n?a.jsx("div",{className:["db-race-water-whispers",t?"db-race-water-whispers--night":""].join(" "),"aria-hidden":!0,children:O.map((d,h)=>{const p=i[h];if(p.gone&&p.visibleParts===0)return null;const{placement:o}=d;return a.jsx(m.p,{className:"db-race-water-whisper-line",style:{left:o.left,right:o.right,top:o.top,maxWidth:o.maxWidth,textAlign:o.textAlign??"left",transform:`rotate(${o.rotate}deg)`,transformOrigin:o.transformOrigin??"0 50%"},initial:!1,animate:{opacity:p.fading?0:1},transition:{duration:e?0:p.fading?c1:.6,ease:"easeOut"},children:d.segments.map((y,u)=>a.jsx(m.span,{className:"db-race-water-whisper-part",initial:!1,animate:{opacity:p.visibleParts>u?1:0},transition:{duration:e?0:w1,ease:[.22,1,.36,1]},children:y},u))},h)})}):null}const S1=K/1e3,B2=[.38,.02,.18,1],E2=3200,y1=3.6,O2=Math.round(y1*1e3)+80,D2=280,H1=[0,.45,.45,1],q1=[.42,0,.58,1],I2=118,z2="-118vw";function s1(n){if(!n)return 0;const t=n.style.transform||window.getComputedStyle(n).transform;if(!t||t==="none")return 0;const e=t.match(/matrix\(([^)]+)\)/);if(!e)return 0;const i=e[1].split(",").map(l=>parseFloat(l.trim()));return i.length<6||Number.isNaN(i[4])?0:i[4]/window.innerWidth*100}function d1(n){const t=n+I2;return[`${n}vw`,`${t}vw`,z2,"0vw"]}function j1({classSuffix:n,boatIndex:t,isNight:e,isExitingMorph:i,driftDuration:l,baseOpacity:c,rowBurst:d,burstPath:h,boatRef:p}){const o=S(),y=d&&h!==null;return a.jsx(m.div,{ref:p,className:`db-layout-race-far db-layout-race-far--${n}`,initial:!1,animate:i?{opacity:0,x:"16vw",y:"-2%"}:y?{opacity:c,x:h,y:0}:o?{opacity:c,x:0,y:0}:{opacity:c,x:["-5vw","6vw"],y:[0,"-1.2%",0]},transition:i?{duration:.5,ease:[.4,0,.2,1]}:y?{duration:y1,ease:q1,times:[...H1]}:o?{duration:0}:{duration:l,repeat:1/0,repeatType:"mirror",ease:"easeInOut"},children:a.jsx(L1,{index:t,isNight:e,showLabel:!1,morphLite:i,rowBurst:d&&!i})})}function P2({beat:n,onDark:t,isNight:e,enterFromMorph:i,isExitingMorph:l=!1,onMorphComplete:c}){const d=S(),p=s.useRef(i&&!d).current,o=s.useRef(!1),[y,u]=s.useState(!1),[r,g]=s.useState(null),M=s.useRef(0),f=s.useRef(null),b=s.useRef(null),k=s.useRef(null),j=s.useRef(null),Z=s.useRef(null),A=s.useRef(null),x=s.useRef(null),v=s.useRef(!1),[T,D]=s.useState(!1),N=s.useCallback(()=>{!l||o.current||(o.current=!0,c==null||c())},[l,c]);s.useEffect(()=>{if(!l){o.current=!1;return}if(d){N();return}const L=window.setTimeout(N,f2),z=window.setTimeout(N,K+100);return()=>{window.clearTimeout(L),window.clearTimeout(z)}},[l,d,N]),s.useEffect(()=>()=>{f.current&&window.clearTimeout(f.current),b.current&&window.clearTimeout(b.current),k.current&&window.clearTimeout(k.current)},[]);const I=s.useCallback(()=>{if(d||l)return;const L=s1(j.current),z=s1(Z.current),X=s1(A.current);g({near:d1(L),far1:d1(z),far2:d1(X)}),u(!0),b.current&&window.clearTimeout(b.current),b.current=window.setTimeout(()=>{u(!1),g(null)},O2)},[d,l]),V=s.useCallback(()=>{if(R.ensureReady(),R.playRaceDrum(),M.current+=1,M.current>=3){M.current=0,f.current&&window.clearTimeout(f.current),k.current&&window.clearTimeout(k.current),v.current||(v.current=!0,D(!0)),k.current=window.setTimeout(()=>{I(),k.current=null},D2);return}f.current&&window.clearTimeout(f.current),f.current=window.setTimeout(()=>{M.current=0},E2)},[I]);return a.jsxs(l1,{className:"db-layout-race-diagonal",variant:"stage",children:[a.jsxs("div",{className:"db-layout-race-diagonal-copy",children:[a.jsx("h2",{className:["db-ink-display db-ink-display--hero db-layout-race-title",t?"db-ink-display--on-dark":"db-ink-display--on-light"].join(" "),children:a.jsx(m.span,{className:"db-race-title-char",style:{transformOrigin:"50% 100%",display:"inline-block"},initial:p?{opacity:.6,x:-12}:d?!1:{opacity:0,y:28},animate:l?{opacity:0,x:-12,y:-8}:{opacity:1,x:0,y:0},transition:l?{duration:.38,ease:[.4,0,.2,1]}:{delay:p?.35:.08,duration:.62,ease:[.22,1,.36,1]},children:n.display})}),n.subtitle&&a.jsx(m.p,{className:["db-ink-subtitle",t?"text-stone-300":"text-stone-600"].join(" "),initial:p?{opacity:0}:d?!1:{opacity:0,y:14},animate:l?{opacity:0,y:-6}:{opacity:1,y:0},transition:l?{duration:.32,delay:.04,ease:[.4,0,.2,1]}:{delay:p?.52:.42,duration:.55,ease:[.22,1,.36,1]},children:n.subtitle}),n.body&&n.body.length>0&&a.jsx(f1,{lines:n.body,onDark:t,variant:"asymmetric",baseDelay:p?.62:.52,exiting:l,exitBaseDelay:.02})]}),a.jsxs(m.div,{className:"db-layout-race-far-lane","aria-hidden":!0,animate:l?{opacity:0}:{opacity:1},transition:{duration:l?.48:.2,ease:[.4,0,.2,1]},children:[a.jsx(j1,{classSuffix:"1",boatIndex:3,isNight:e,isExitingMorph:l,driftDuration:26,baseOpacity:.3,rowBurst:y&&!l,burstPath:(r==null?void 0:r.far1)??null,boatRef:Z}),a.jsx(j1,{classSuffix:"2",boatIndex:2,isNight:e,isExitingMorph:l,driftDuration:34,baseOpacity:.48,rowBurst:y&&!l,burstPath:(r==null?void 0:r.far2)??null,boatRef:A})]}),a.jsx(m.div,{ref:j,className:"db-layout-race-boat",initial:p?{opacity:.75,x:"-18vw",y:"14%",scale:.92}:d?!1:{opacity:0,x:"-28vw",y:"12%"},animate:l?{opacity:.92,x:"108vw",y:"-3%",scale:1.12}:y&&r?{opacity:1,x:r.near,y:0,scale:1}:{opacity:1,x:0,y:0,scale:1},transition:l?{duration:S1,ease:B2,delay:.06}:y&&r?{duration:y1,ease:q1,times:[...H1]}:{delay:p?.12:d?0:.42,duration:p?1.15:1.05,ease:[.22,1,.36,1]},children:a.jsx(L1,{index:1,isNight:e,showLabel:!1,morphLite:l,rowBurst:y&&!l,hitTargetRef:x})}),a.jsx(q2,{hitTargetRef:x,onTap:V,disabled:l,isNight:e}),a.jsx(_2,{active:T&&!l,isNight:e}),l&&a.jsx(m.div,{className:"db-layout-race-warm-glow",style:{background:r2(e)},initial:{opacity:0,scale:.88},animate:{opacity:.85,scale:1.04},transition:{duration:S1*.85,delay:.12,ease:[.32,.72,0,1]},"aria-hidden":!0})]})}const $2={sm:"db-mugwort-mark--sm",md:"db-mugwort-mark--md",lg:"db-mugwort-mark--lg"};function W2({className:n,size:t="md",animate:e=!0}){const i=S(),l=a.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 30 70",fill:"none",role:"img","aria-label":"艾",className:"db-mugwort-mark-svg",children:[a.jsx("path",{d:"M 15 20 C 5 25, 2 45, 12 55 C 10 40, 12 30, 15 20 Z",fill:"#047857",opacity:"0.95"}),a.jsx("path",{d:"M 15 20 C 25 25, 28 45, 18 55 C 20 40, 18 30, 15 20 Z",fill:"#065F46",opacity:"0.9"}),a.jsx("path",{d:"M 15 5 L 8 45 C 8 45, 15 50, 15 65 C 15 50, 22 45, 22 45 L 15 5 Z",fill:"#059669"}),a.jsx("rect",{x:"11",y:"32",width:"8",height:"3",rx:"1.5",fill:"#EF4444"}),a.jsx("path",{d:"M 14 35 Q 11 50, 12 60 M 16 35 Q 19 50, 18 60",stroke:"#EF4444",strokeWidth:"1"})]}),c=["db-mugwort-mark",$2[t],n].filter(Boolean).join(" ");return!e||i?a.jsx("span",{className:c,children:l}):a.jsx(m.span,{className:c,initial:{opacity:0,y:-8,scale:.85},animate:{opacity:1,y:0,scale:1},transition:{delay:.28,duration:.55,ease:[.22,1,.36,1]},children:l})}const V2=`  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1153.44 1086.59" style="vertical-align: middle; max-width: 100%; width: 100%;" width="100%">
   <g>
    <g>
...
`,Y2=V2,U2=X2,G2={sm:"db-treat-svg--sm",md:"db-treat-svg--md",lg:"db-treat-svg--lg"};function J2({raw:n,size:t="md",className:e,label:i}){return a.jsx("span",{className:["db-treat-svg",G2[t],e].filter(Boolean).join(" "),role:"img","aria-label":i,dangerouslySetInnerHTML:{__html:n}})}function Q2({className:n,size:t="lg",enterAnimate:e=!0}){const i=S(),[l,c]=s.useState(!1),[d,h]=s.useState(!e||i),p=()=>{c(u=>!u),d||h(!0)},o=i?{initial:!1,animate:{opacity:1},exit:{opacity:0},transition:{duration:.12}}:{initial:{opacity:0,scale:.92,y:8,filter:"blur(5px)"},animate:{opacity:1,scale:1,y:0,filter:"blur(0px)"},exit:{opacity:0,scale:.94,y:-6,filter:"blur(4px)"},transition:{duration:.48,ease:[.22,1,.36,1]}},y=!d&&e&&!i?{initial:{opacity:0,scale:.6,y:10},animate:{opacity:1,scale:1,y:0}}:{};return a.jsx("button",{type:"button",className:["db-zongzi-flip-treat",n].filter(Boolean).join(" "),onClick:u=>{u.stopPropagation(),p()},"aria-label":l?"甜筒变回粽子":"粽子变甜筒","aria-pressed":l,children:a.jsx("span",{className:"db-zongzi-flip-treat-stage",children:a.jsx(W,{mode:"wait",initial:!1,children:a.jsx(m.span,{className:"db-zongzi-flip-treat-inner",...o,...!l&&!d?y:{},onAnimationComplete:()=>{d||h(!0)},children:a.jsx(J2,{raw:l?U2:Y2,size:t,label:l?"甜筒":"粽"})},l?"ice":"zong")})})})}const J={hidden:{opacity:0,x:14},visible:{opacity:1,x:0,transition:{duration:.4,ease:[.22,1,.36,1]}}};function h1({text:n,className:t,hide:e}){return e?null:a.jsx(m.p,{className:["db-festive-vertical-text",t].filter(Boolean).join(" "),variants:J,children:n})}function K2({beat:n,onDark:t,enterFromMorph:e,isExitingMorph:i=!1,onMorphComplete:l}){var M;const c=S(),h=s.useRef(e&&!c).current,p=s.useRef(!1),o=(M=n.body)==null?void 0:M[n.body.length-1],y=n.body&&n.body.length>1?n.body.slice(0,-1):n.body,u=h?{hidden:{opacity:0,x:32},visible:{opacity:1,x:0,transition:{duration:.52,ease:[.22,1,.36,1],staggerChildren:.04,delayChildren:.05}}}:{hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.07,delayChildren:.1}}},r=s.useCallback(()=>{!i||p.current||(p.current=!0,l==null||l())},[i,l]);s.useEffect(()=>{if(!i){p.current=!1;return}if(c){r();return}const f=window.setTimeout(r,o2),b=window.setTimeout(r,o1+80);return()=>{window.clearTimeout(f),window.clearTimeout(b)}},[i,c,r]);const g=t?"db-ink-display--on-dark":"db-ink-display--on-light";return a.jsxs(l1,{className:"db-layout-festive-vertical",variant:"split",children:[a.jsxs(m.aside,{className:"db-layout-festive-side",initial:h&&!c?{opacity:0,x:16}:!1,animate:i?{opacity:0,x:-16}:{opacity:1,x:0},transition:{duration:i?.36:h?.48:.35,delay:h&&!i?.04:0,ease:[.22,1,.36,1]},children:[a.jsx(W2,{size:"lg",className:"db-festive-side-mugwort",animate:!h&&!i}),!i&&a.jsx(Q2,{size:"lg",className:"db-festive-side-zongzi",enterAnimate:!h&&!i})]}),a.jsxs(m.div,{className:"db-layout-festive-columns",variants:u,initial:c?!1:"hidden",animate:i?{opacity:0,x:-28}:"visible",transition:i?{duration:.42,ease:[.38,.02,.18,1]}:void 0,children:[a.jsx(m.div,{className:"db-festive-vcol db-festive-vcol--title",variants:J,children:a.jsxs("h2",{className:["db-festive-title-vertical",g].join(" "),"aria-label":"节物",children:[a.jsx("span",{className:"db-festive-title-char",children:"节"}),a.jsx("span",{className:"db-festive-title-char",children:"物"})]})}),n.subtitle&&a.jsx(m.div,{className:"db-festive-vcol",variants:J,children:a.jsx(h1,{text:n.subtitle,className:t?"text-stone-200/90":"text-stone-700",hide:i})}),y==null?void 0:y.map(f=>a.jsx(m.div,{className:"db-festive-vcol",variants:J,children:a.jsx(h1,{text:f,className:t?"text-stone-200/88":"text-stone-700/95",hide:i})},f)),o&&a.jsx(m.div,{className:"db-festive-vcol db-festive-vcol--bridge",variants:J,children:a.jsx(h1,{text:o,className:t?"text-amber-100/85":"text-emerald-950/85",hide:i})})]})]})}function n0({beat:n,isNight:t}){const e=`db-ambient db-ambient--${n.id}${t?" db-ambient--night":""}`;return a.jsxs("div",{className:e,"aria-hidden":!0,children:[n.id==="prologue"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-ambient-spot db-ambient-spot--a"}),a.jsx("div",{className:"db-ambient-spot db-ambient-spot--b"}),a.jsx("div",{className:"db-ambient-spot db-ambient-spot--c"})]}),n.id==="river"&&a.jsxs(a.Fragment,{children:[a.jsxs("div",{className:"db-ambient-mountains","aria-hidden":!0,children:[a.jsx("div",{className:"db-ambient-mountain db-ambient-mountain--back"}),a.jsx("div",{className:"db-ambient-mountain db-ambient-mountain--mid"}),a.jsx("div",{className:"db-ambient-mountain db-ambient-mountain--front"})]}),a.jsx("div",{className:"db-ambient-mist"}),a.jsx("div",{className:"db-ambient-ripple-band"}),a.jsx("div",{className:"db-ambient-waterline"})]}),n.id==="festive"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-ambient-smoke db-ambient-smoke--1"}),a.jsx("div",{className:"db-ambient-smoke db-ambient-smoke--2"}),a.jsx("div",{className:"db-ambient-leaf db-ambient-leaf--1"}),a.jsx("div",{className:"db-ambient-leaf db-ambient-leaf--2"})]}),n.id==="letter"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-ambient-paper-shimmer"}),a.jsx("div",{className:"db-ambient-ink-wet"})]}),n.id==="finale"&&a.jsx("div",{className:"db-ambient-gold-dust",children:Array.from({length:12},(i,l)=>a.jsx("span",{className:"db-ambient-gold-particle",style:{"--p-i":l}},l))})]})}function a0({isNight:n,isExiting:t,onComplete:e}){const i=S(),l=s.useRef(!1),c=s.useCallback(()=>{!t||l.current||(l.current=!0,e==null||e())},[t,e]);if(s.useEffect(()=>{if(!t){l.current=!1;return}if(i){c();return}const h=window.setTimeout(c,a1+120);return()=>window.clearTimeout(h)},[t,i,c]),!t)return null;const d=G("river",n);return a.jsxs(a.Fragment,{children:[a.jsx(m.div,{className:"db-morph-ink-bloom pointer-events-none absolute inset-0 z-[12]",style:{background:n?"radial-gradient(ellipse 45% 38% at 50% 42%, rgba(2,44,29,0.95) 0%, transparent 72%)":"radial-gradient(ellipse 45% 38% at 50% 42%, rgba(28,25,23,0.88) 0%, transparent 72%)"},initial:{opacity:0,scale:.15},animate:{opacity:1,scale:2.8},transition:{duration:a1/1e3,ease:[.32,.72,0,1]},onAnimationComplete:c,"aria-hidden":!0}),a.jsx(m.div,{className:"db-morph-ink-river pointer-events-none absolute inset-0 z-[11]",style:{background:d},initial:{opacity:0},animate:{opacity:1},transition:{duration:a1/1e3,delay:.22,ease:[.22,1,.36,1]},"aria-hidden":!0})]})}const t0=2.1,l0={"top-left":"db-scroll-egg--top-left","top-right":"db-scroll-egg--top-right","bottom-left":"db-scroll-egg--bottom-left","bottom-right":"db-scroll-egg--bottom-right","mid-left":"db-scroll-egg--mid-left"};function e0({egg:n,theme:t,onDark:e,isNight:i,index:l,hidden:c,onTap:d}){const[h,p]=s.useState(!1),o=S();if(c)return null;const y=n.anchor.includes("right"),u=i||e?"text-amber-100/90":"text-emerald-900";return a.jsxs(m.div,{className:["db-scroll-egg-slot",l0[n.anchor]].join(" "),initial:o?{}:{opacity:0},animate:{opacity:1},transition:{delay:.85+l*.08,duration:.4},children:[a.jsx(m.button,{type:"button",className:["db-scroll-egg",n.hint&&"db-scroll-egg--hint",t.egg,t.eggHover,"border-0 bg-transparent font-serif"].join(" "),onClick:r=>{r.stopPropagation(),n.reveal&&(p(g=>!g),d==null||d())},"aria-expanded":h,"aria-label":n.reveal?`彩蛋：${n.text}`:n.text,children:n.text}),a.jsx(W,{children:h&&n.reveal&&a.jsx(m.p,{initial:{opacity:0,x:y?8:-8,filter:"blur(4px)"},animate:{opacity:1,x:0,filter:"blur(0px)"},exit:{opacity:0,x:y?6:-6},transition:{duration:.35},className:["db-scroll-egg-reveal",n.hint&&"db-scroll-egg-reveal--hint",u].join(" "),children:n.reveal})})]})}function i0({beat:n,isNight:t,onDark:e,morphPhase:i,onMorphComplete:l,enterFromMorph:c,letterEnterFromMorph:d}){const h=S(),p=i==="morph-jiang"&&n.id==="river",o=i==="morph-boat"&&n.id==="race",y=i==="morph-zongzi-seal"&&n.id==="festive";if(n.layout==="river-glyph")return a.jsx(S2,{beat:n,onDark:e,isNight:t,isExitingMorph:p,onMorphComplete:l});if(n.layout==="race-diagonal")return a.jsx(P2,{beat:n,onDark:e,isNight:t,enterFromMorph:c==="morph-jiang",isExitingMorph:o,onMorphComplete:l});if(n.layout==="festive-split")return a.jsx(K2,{beat:n,onDark:e,enterFromMorph:c==="morph-boat",isExitingMorph:y,onMorphComplete:l});const u=a.jsxs(l1,{className:["db-scene-layout--center",n.bodyVariant==="letter"?"db-scroll-content--letter":""].filter(Boolean).join(" "),variant:"stack",children:[a.jsx(s2,{text:n.display,mode:n.displayMode,onDark:e}),n.subtitle&&a.jsx(d2,{text:n.subtitle,onDark:e}),n.body&&n.body.length>0&&a.jsx(f1,{lines:n.body,onDark:e,variant:n.bodyVariant??"center"})]});return n.id==="letter"&&d?a.jsx(m.div,{className:"db-scene-layout-letter-enter",initial:h?!1:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.48,delay:.05,ease:[.22,1,.36,1]},children:u}):u}function c0({beat:n,isNight:t,theme:e,introComplete:i=!0,onUnrollComplete:l,morphPhase:c,onMorphComplete:d,enterFromMorph:h,onEggTap:p}){const o=S(),y=R1(n.material,t),u=n.material==="dawn"&&!t,r=G(n.material,t),g=n.layout!=="center",M=n.id==="prologue"&&!i&&!o,f=c==="morph-jiang"||c==="morph-boat"||c==="morph-ink"||c==="morph-zongzi-seal",b=c==="morph-ink"&&n.id==="prologue",j=s.useRef(h==="morph-zongzi-seal"&&!o).current,Z=c==="morph-jiang"&&n.id==="river"?G("race",t):c==="morph-boat"&&n.id==="race"?G("festive",t):c==="morph-zongzi-seal"&&n.id==="festive"?G("paper",t):null;return s.useEffect(()=>{if(!M||!l)return;const A=window.setTimeout(l,t0*1e3);return()=>window.clearTimeout(A)},[M,l]),a.jsxs("div",{className:["db-scroll-scene",n.material==="paper"?"db-scroll-scene--paper":"",g?"db-scroll-scene--layout":"",M?"db-scroll-scene--unrolling":"",f?"db-scroll-scene--morphing":"",u?"db-scroll-scene--dawn-day":"",n.id==="race"?"db-scroll-scene--race":"",n.id==="festive"?"db-scroll-scene--festive":""].join(" "),style:{background:r},role:"group","aria-roledescription":"slide","aria-label":`${n.display}${n.subtitle?`，${n.subtitle}`:""}`,children:[M&&a.jsx("div",{className:"db-scroll-unroll-edge","aria-hidden":!0}),a.jsx(n0,{beat:n,isNight:t}),a.jsx(a0,{isNight:t,isExiting:b,onComplete:d}),Z&&a.jsx("div",{className:["db-morph-bg-crossfade pointer-events-none absolute inset-0 z-[1]",c==="morph-boat"?"db-morph-bg-crossfade--boat":"",c==="morph-jiang"?"db-morph-bg-crossfade--jiang":"",c==="morph-zongzi-seal"?"db-morph-bg-crossfade--letter":""].filter(Boolean).join(" "),style:{background:Z,animationDuration:c==="morph-boat"||c==="morph-jiang"||c==="morph-zongzi-seal"?void 0:`${K}ms`},"aria-hidden":!0}),a.jsx(h2,{chapter:n.chapter,sceneLabel:n.sceneLabel,onDark:y}),t&&n.material==="dawn"&&a.jsx("div",{className:"pointer-events-none absolute inset-x-0 top-0 h-1/2 opacity-60",style:{background:"radial-gradient(circle at 50% 0%, rgba(252,211,77,0.12) 0%, transparent 65%)"},"aria-hidden":!0}),!t&&n.material==="dawn"&&a.jsx("div",{className:"pointer-events-none absolute inset-x-0 top-0 h-2/3",style:{background:"radial-gradient(circle at 50% 0%, rgba(252,211,77,0.22) 0%, transparent 70%)"},"aria-hidden":!0}),n.material==="river"&&n.layout==="center"&&a.jsx(m.svg,{className:"pointer-events-none absolute inset-x-0 top-[16%] h-28 w-full opacity-25",viewBox:"0 0 400 40",preserveAspectRatio:"none","aria-hidden":!0,initial:o?{}:{x:"-4%"},animate:{x:"4%"},transition:{duration:8,repeat:1/0,repeatType:"reverse",ease:"easeInOut"},children:a.jsx("path",{d:"M0 25 Q100 8, 200 22 T400 18 L400 40 L0 40 Z",fill:t?"#065f46":"#98B5A8"})}),n.material==="paper"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-scroll-paper-texture pointer-events-none absolute inset-[8%] rounded-sm opacity-90","aria-hidden":!0}),a.jsx("div",{className:"db-scroll-paper-margin pointer-events-none absolute inset-y-[10%] left-[10%] w-px bg-stone-400/25","aria-hidden":!0})]}),a.jsx(i0,{beat:n,isNight:t,onDark:y,morphPhase:c,onMorphComplete:d,enterFromMorph:h,letterEnterFromMorph:j}),n.eggs.map((A,x)=>a.jsx(e0,{egg:A,theme:e,onDark:y,isNight:t,index:x,hidden:f,onTap:p},A.id))]})}const s0=m.create(c0);function d0({visible:n,onDark:t=!0}){const e=S();return n?a.jsxs("div",{className:`db-scroll-hint ${t?"text-stone-300":"text-stone-600"}`,"aria-hidden":!0,children:[a.jsx(m.div,{className:"db-scroll-hint-chevron",animate:e?{}:{y:[0,6,0],opacity:[.5,1,.5]},transition:{duration:1.6,repeat:1/0,ease:"easeInOut"}}),a.jsx("span",{children:"向上滑动 · 滚轮展卷"})]}):null}function h0({index:n,visited:t,onSelect:e}){return a.jsx("nav",{className:"db-scroll-seals","aria-label":"长卷分幕",children:Q.map((i,l)=>{const c=l===n,d=t.has(l)&&!c;return a.jsx("button",{type:"button","aria-label":`${i.chapter} · ${i.sceneLabel}`,"aria-current":c?"step":void 0,onClick:()=>e(l),className:["db-scroll-seal",c?"db-scroll-seal--active":"",d?"db-scroll-seal--visited":""].filter(Boolean).join(" "),children:a.jsx("span",{className:"db-scroll-seal-face","aria-hidden":!0,children:i.chapter})},i.id)})})}function r0({pulse:n,direction:t,isNight:e}){if(S()||n===0)return null;const l=e?"linear-gradient(180deg, rgba(2,44,29,0) 0%, rgba(2,44,29,0.92) 45%, rgba(1,6,4,0.98) 100%)":"linear-gradient(180deg, rgba(74,100,88,0) 0%, rgba(42,66,56,0.75) 40%, rgba(2,44,29,0.88) 100%)";return a.jsx(W,{mode:"wait",children:a.jsx(m.div,{className:"db-transition-curtain",style:{background:l,transformOrigin:t>0?"50% 100%":"50% 0%"},initial:{scaleY:0,opacity:.6},animate:{scaleY:[0,1.05,0],opacity:[.5,.92,0]},exit:{opacity:0},transition:{duration:.78,ease:[.76,0,.24,1],times:[0,.42,1]},"aria-hidden":!0},n)})}const p0={enter:n=>({opacity:0,y:n>0?"14%":"-14%",scale:.92,filter:"blur(12px)"}),center:{opacity:1,y:0,scale:1,filter:"blur(0px)"},exit:n=>({opacity:0,y:n>0?"-22%":"22%",scale:1.04,filter:"blur(14px)"})},f0={duration:.72,ease:[.32,.72,0,1]},o0=42,y0=52,k1=820,u0=Math.max(...y2)+80,M0=new Set(["morph-ink","morph-jiang","morph-boat","morph-zongzi-seal"]);function Z0(n){return!!n&&M0.has(n)}function m0({isNight:n,theme:t,onFirstAdvance:e,soundEnabled:i=!0}){const[l,c]=s.useState(0),[d,h]=s.useState(1),[p,o]=s.useState(!0),[y,u]=s.useState(0),[r,g]=s.useState(!1),[M,f]=s.useState(null),[b,k]=s.useState(null),[j,Z]=s.useState(null),[A,x]=s.useState(()=>new Set([0])),v=s.useRef(0),T=s.useRef(null),D=s.useRef(null),N=s.useRef(0),I=s.useRef(null),V=s.useRef(null),L=s.useRef(!1),z=s.useRef(0),X=S();s.useEffect(()=>{R.setMuted(!i)},[i]),s.useEffect(()=>{X&&g(!0)},[X]),s.useEffect(()=>{T.current=b,D.current=M},[b,M]),s.useEffect(()=>{x(w=>{const F=new Set(w);for(let q=0;q<=l;q++)F.add(q);return F});const C=z.current;l!==C&&l===4&&l>C&&R.playLetterOpen(),z.current=l},[l]),s.useEffect(()=>{if(!r)return;R.ensureReady();const C=()=>R.ensureReady();return window.addEventListener("pointerdown",C,{once:!0}),()=>window.removeEventListener("pointerdown",C)},[r]);const u1=s.useCallback(C=>{switch(C){case"morph-ink":R.playMorphInk();break;case"morph-jiang":R.playMorphWater();break;case"morph-boat":R.playMorphDrum();break;case"morph-zongzi-seal":R.playMorphSeal();break}},[]),Y=s.useCallback(C=>{var _;const w=Math.max(0,Math.min(t2-1,C));if(w===l||!r||M||Date.now()<v.current)return;const F=w>l?1:-1;if(h(F),F>0){const B=l2(l,w);if(B){f(B),k(w),u1(B),v.current=Date.now()+u0,N.current=0;return}}Z(null),(F>0&&((_=Q[l])==null?void 0:_.forwardTransition)==="light-curtain"||F<0)&&u(B=>B+1),c(w),v.current=Date.now()+k1,N.current=0,!L.current&&w>0&&(L.current=!0,o(!1),e==null||e())},[l,r,M,e,u1]),_1=s.useCallback(()=>{const C=T.current;if(C==null){f(null);return}const w=D.current;Z(w),c(C),k(null),f(null),v.current=Date.now()+k1,!L.current&&C>0&&(L.current=!0,o(!1),e==null||e()),requestAnimationFrame(()=>Z(null))},[e]),P=s.useCallback(()=>Y(l+1),[Y,l]),$=s.useCallback(()=>Y(l-1),[Y,l]),B1=s.useCallback(()=>{g(!0),R.playUnroll()},[]),E1=s.useCallback(()=>{R.playEggTap()},[]);s.useEffect(()=>{const C=V.current;if(!C)return;const w=F=>{F.preventDefault(),!(!r||M)&&(Date.now()<v.current||(N.current+=F.deltaY,!(Math.abs(N.current)<o0)&&(N.current>0?P():$(),N.current=0)))};return C.addEventListener("wheel",w,{passive:!1}),()=>C.removeEventListener("wheel",w)},[P,$,r,M]),s.useEffect(()=>{const C=V.current;if(!C)return;const w=q=>{var _;I.current=((_=q.touches[0])==null?void 0:_.clientY)??null},F=q=>{var m1;const _=I.current;if(I.current=null,_==null||!r||M)return;const B=(m1=q.changedTouches[0])==null?void 0:m1.clientY;if(B==null)return;const Z1=B-_;Math.abs(Z1)<y0||(Z1<0?P():$())};return C.addEventListener("touchstart",w,{passive:!0}),C.addEventListener("touchend",F,{passive:!0}),()=>{C.removeEventListener("touchstart",w),C.removeEventListener("touchend",F)}},[P,$,r,M]),s.useEffect(()=>{const C=w=>{!r||M||(w.key==="ArrowDown"||w.key==="PageDown"?(w.preventDefault(),P()):(w.key==="ArrowUp"||w.key==="PageUp")&&(w.preventDefault(),$()))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[P,$,r,M]),s.useEffect(()=>()=>R.stopAmbient(),[]);const e1=Q[l],O1=R1(e1.material,n),M1=Z0(M),D1=X?{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.18}}:M1||(j==="morph-jiang"||j==="morph-boat"||j==="morph-ink"||j==="morph-zongzi-seal")?{initial:!1,animate:{opacity:1},exit:{opacity:1},transition:{duration:0}}:{custom:d,variants:p0,initial:"enter",animate:"center",exit:"exit",transition:f0};return a.jsxs("div",{ref:V,className:"relative h-full w-full overflow-hidden",tabIndex:0,"aria-live":"polite",children:[!M1&&a.jsx(r0,{pulse:y,direction:d,isNight:n}),a.jsx(W,{mode:"wait",custom:d,children:a.jsx(s0,{beat:e1,direction:d,isNight:n,theme:t,introComplete:r,onUnrollComplete:B1,morphPhase:M,onMorphComplete:_1,enterFromMorph:j,onEggTap:E1,...D1},e1.id)}),a.jsx(d0,{visible:p&&l===0&&r,onDark:O1}),a.jsx(h0,{index:l,visited:A,onSelect:Y})]})}const b0=""+new URL("ambient-BBYjlx1c.mp3",import.meta.url).href;function g0(){R.setAmbientSrc(b0)}function C0({theme:n,onBackToArchive:t,onBackToCabinet:e}){const i=!!(n!=null&&n.isNight),l=a2(i),[c,d]=s.useState(!0);return s.useEffect(()=>(X1(Y1("festival-2026-DragonBoat")),g0(),()=>{R.dispose()}),[]),a.jsxs(U1,{id:"dragon-boat-scroll-root",className:"relative h-full min-h-0 overflow-hidden font-serif select-none [&_.viewport-main]:overflow-hidden [&_.viewport-main-inner]:h-full [&_.viewport-main-inner]:min-h-0",children:[a.jsx("div",{className:"pointer-events-none absolute inset-0 z-0",style:{background:i?"#0a2018":"#FCFBEB"},"aria-hidden":!0}),a.jsx("div",{className:"pointer-events-none absolute inset-x-0 top-0 z-[1] h-48 opacity-80",style:{background:l.sunAura},"aria-hidden":!0}),a.jsxs("header",{className:"pointer-events-auto absolute inset-x-0 top-0 z-30 flex items-center justify-between px-3 pb-1 pt-[max(0.5rem,env(safe-area-inset-top))] md:px-4",children:[a.jsx("div",{className:"flex items-center gap-2",children:e&&a.jsxs("button",{type:"button",onClick:e,className:`flex cursor-pointer items-center gap-1.5 rounded-full border px-3 py-1.5 font-serif text-xs font-bold transition-all active:scale-95 ${l.headerBtn}`,children:[a.jsx(G1,{className:"h-3.5 w-3.5 text-emerald-400"}),a.jsx("span",{children:"返回展柜"})]})}),a.jsxs("div",{className:"flex items-center",children:[t&&a.jsxs("button",{type:"button",onClick:t,className:"flex cursor-pointer items-center gap-1.5 rounded-full border border-emerald-700/40 bg-emerald-950/30 px-3 py-1.5 font-serif text-xs text-stone-300 transition-all hover:bg-emerald-900/50 hover:text-emerald-300 active:scale-95",children:[a.jsx(n2,{className:"h-3.5 w-3.5 text-emerald-400"}),a.jsx("span",{children:"节日风物志"})]}),a.jsx("button",{type:"button",onClick:()=>d(h=>!h),className:`ml-2 flex cursor-pointer items-center justify-center rounded-full border p-2 transition-all active:scale-95 ${l.headerBtn}`,"aria-label":c?"关闭端午页音效":"开启端午页音效",title:c?"关闭音效":"开启音效",children:c?a.jsx(J1,{className:"h-3.5 w-3.5 text-emerald-400"}):a.jsx(Q1,{className:"h-3.5 w-3.5 text-stone-400"})})]})]}),a.jsx("main",{className:"relative z-10 h-full min-h-0 w-full flex-1",children:a.jsx(m0,{isNight:i,theme:l,soundEnabled:c})})]})}export{C0 as DragonBoatScroll};

...
`,v2=A2,w2=x2,S2=C2,j2={3:v2,2:w2,1:S2};function L1({index:n,label:t="近舟",isNight:e,showLabel:i=!1,morphLite:l=!1,rowBurst:c=!1,hitTargetRef:d}){const h=j2[n],p=n===1?"0.9s":"1.15s",o=n===1?"0.6s":"0.77s",y=c?"0.28s":"0.55s",u=c?o:p,r=`
...
`,I2=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   viewBox="0 0 500 500"
   version="1.1"
   id="svg84"
...
`,z2=D2,P2=I2,$2={sm:"db-treat-svg--sm",md:"db-treat-svg--md",lg:"db-treat-svg--lg"};function W2({raw:n,size:t="md",className:e,label:i}){return a.jsx("span",{className:["db-treat-svg",$2[t],e].filter(Boolean).join(" "),role:"img","aria-label":i,dangerouslySetInnerHTML:{__html:n}})}function V2({className:n,size:t="lg",enterAnimate:e=!0}){const i=S(),[l,c]=s.useState(!1),[d,h]=s.useState(!e||i),p=()=>{c(u=>!u),d||h(!0)},o=i?{initial:!1,animate:{opacity:1},exit:{opacity:0},transition:{duration:.12}}:{initial:{opacity:0,scale:.92,y:8,filter:"blur(5px)"},animate:{opacity:1,scale:1,y:0,filter:"blur(0px)"},exit:{opacity:0,scale:.94,y:-6,filter:"blur(4px)"},transition:{duration:.48,ease:[.22,1,.36,1]}},y=!d&&e&&!i?{initial:{opacity:0,scale:.6,y:10},animate:{opacity:1,scale:1,y:0}}:{};return a.jsx("button",{type:"button",className:["db-zongzi-flip-treat",n].filter(Boolean).join(" "),onClick:u=>{u.stopPropagation(),p()},"aria-label":l?"甜筒变回粽子":"粽子变甜筒","aria-pressed":l,children:a.jsx("span",{className:"db-zongzi-flip-treat-stage",children:a.jsx(W,{mode:"wait",initial:!1,children:a.jsx(m.span,{className:"db-zongzi-flip-treat-inner",...o,...!l&&!d?y:{},onAnimationComplete:()=>{d||h(!0)},children:a.jsx(W2,{raw:l?P2:z2,size:t,label:l?"甜筒":"粽"})},l?"ice":"zong")})})})}const J={hidden:{opacity:0,x:14},visible:{opacity:1,x:0,transition:{duration:.4,ease:[.22,1,.36,1]}}};function h1({text:n,className:t,hide:e}){return e?null:a.jsx(m.p,{className:["db-festive-vertical-text",t].filter(Boolean).join(" "),variants:J,children:n})}function X2({beat:n,onDark:t,enterFromMorph:e,isExitingMorph:i=!1,onMorphComplete:l}){var M;const c=S(),h=s.useRef(e&&!c).current,p=s.useRef(!1),o=(M=n.body)==null?void 0:M[n.body.length-1],y=n.body&&n.body.length>1?n.body.slice(0,-1):n.body,u=h?{hidden:{opacity:0,x:32},visible:{opacity:1,x:0,transition:{duration:.52,ease:[.22,1,.36,1],staggerChildren:.04,delayChildren:.05}}}:{hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.07,delayChildren:.1}}},r=s.useCallback(()=>{!i||p.current||(p.current=!0,l==null||l())},[i,l]);s.useEffect(()=>{if(!i){p.current=!1;return}if(c){r();return}const f=window.setTimeout(r,s2),b=window.setTimeout(r,o1+80);return()=>{window.clearTimeout(f),window.clearTimeout(b)}},[i,c,r]);const g=t?"db-ink-display--on-dark":"db-ink-display--on-light";return a.jsxs(l1,{className:"db-layout-festive-vertical",variant:"split",children:[a.jsxs(m.aside,{className:"db-layout-festive-side",initial:h&&!c?{opacity:0,x:16}:!1,animate:i?{opacity:0,x:-16}:{opacity:1,x:0},transition:{duration:i?.36:h?.48:.35,delay:h&&!i?.04:0,ease:[.22,1,.36,1]},children:[a.jsx(O2,{size:"lg",className:"db-festive-side-mugwort",animate:!h&&!i}),!i&&a.jsx(V2,{size:"lg",className:"db-festive-side-zongzi",enterAnimate:!h&&!i})]}),a.jsxs(m.div,{className:"db-layout-festive-columns",variants:u,initial:c?!1:"hidden",animate:i?{opacity:0,x:-28}:"visible",transition:i?{duration:.42,ease:[.38,.02,.18,1]}:void 0,children:[a.jsx(m.div,{className:"db-festive-vcol db-festive-vcol--title",variants:J,children:a.jsxs("h2",{className:["db-festive-title-vertical",g].join(" "),"aria-label":"节物",children:[a.jsx("span",{className:"db-festive-title-char",children:"节"}),a.jsx("span",{className:"db-festive-title-char",children:"物"})]})}),n.subtitle&&a.jsx(m.div,{className:"db-festive-vcol",variants:J,children:a.jsx(h1,{text:n.subtitle,className:t?"text-stone-200/90":"text-stone-700",hide:i})}),y==null?void 0:y.map(f=>a.jsx(m.div,{className:"db-festive-vcol",variants:J,children:a.jsx(h1,{text:f,className:t?"text-stone-200/88":"text-stone-700/95",hide:i})},f)),o&&a.jsx(m.div,{className:"db-festive-vcol db-festive-vcol--bridge",variants:J,children:a.jsx(h1,{text:o,className:t?"text-amber-100/85":"text-emerald-950/85",hide:i})})]})]})}function Y2({beat:n,isNight:t}){const e=`db-ambient db-ambient--${n.id}${t?" db-ambient--night":""}`;return a.jsxs("div",{className:e,"aria-hidden":!0,children:[n.id==="prologue"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-ambient-spot db-ambient-spot--a"}),a.jsx("div",{className:"db-ambient-spot db-ambient-spot--b"}),a.jsx("div",{className:"db-ambient-spot db-ambient-spot--c"})]}),n.id==="river"&&a.jsxs(a.Fragment,{children:[a.jsxs("div",{className:"db-ambient-mountains","aria-hidden":!0,children:[a.jsx("div",{className:"db-ambient-mountain db-ambient-mountain--back"}),a.jsx("div",{className:"db-ambient-mountain db-ambient-mountain--mid"}),a.jsx("div",{className:"db-ambient-mountain db-ambient-mountain--front"})]}),a.jsx("div",{className:"db-ambient-mist"}),a.jsx("div",{className:"db-ambient-ripple-band"}),a.jsx("div",{className:"db-ambient-waterline"})]}),n.id==="festive"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-ambient-smoke db-ambient-smoke--1"}),a.jsx("div",{className:"db-ambient-smoke db-ambient-smoke--2"}),a.jsx("div",{className:"db-ambient-leaf db-ambient-leaf--1"}),a.jsx("div",{className:"db-ambient-leaf db-ambient-leaf--2"})]}),n.id==="letter"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-ambient-paper-shimmer"}),a.jsx("div",{className:"db-ambient-ink-wet"})]}),n.id==="finale"&&a.jsx("div",{className:"db-ambient-gold-dust",children:Array.from({length:12},(i,l)=>a.jsx("span",{className:"db-ambient-gold-particle",style:{"--p-i":l}},l))})]})}function U2({isNight:n,isExiting:t,onComplete:e}){const i=S(),l=s.useRef(!1),c=s.useCallback(()=>{!t||l.current||(l.current=!0,e==null||e())},[t,e]);if(s.useEffect(()=>{if(!t){l.current=!1;return}if(i){c();return}const h=window.setTimeout(c,a1+120);return()=>window.clearTimeout(h)},[t,i,c]),!t)return null;const d=G("river",n);return a.jsxs(a.Fragment,{children:[a.jsx(m.div,{className:"db-morph-ink-bloom pointer-events-none absolute inset-0 z-[12]",style:{background:n?"radial-gradient(ellipse 45% 38% at 50% 42%, rgba(2,44,29,0.95) 0%, transparent 72%)":"radial-gradient(ellipse 45% 38% at 50% 42%, rgba(28,25,23,0.88) 0%, transparent 72%)"},initial:{opacity:0,scale:.15},animate:{opacity:1,scale:2.8},transition:{duration:a1/1e3,ease:[.32,.72,0,1]},onAnimationComplete:c,"aria-hidden":!0}),a.jsx(m.div,{className:"db-morph-ink-river pointer-events-none absolute inset-0 z-[11]",style:{background:d},initial:{opacity:0},animate:{opacity:1},transition:{duration:a1/1e3,delay:.22,ease:[.22,1,.36,1]},"aria-hidden":!0})]})}const G2=2.1,J2={"top-left":"db-scroll-egg--top-left","top-right":"db-scroll-egg--top-right","bottom-left":"db-scroll-egg--bottom-left","bottom-right":"db-scroll-egg--bottom-right","mid-left":"db-scroll-egg--mid-left"};function Q2({egg:n,theme:t,onDark:e,isNight:i,index:l,hidden:c,onTap:d}){const[h,p]=s.useState(!1),o=S();if(c)return null;const y=n.anchor.includes("right"),u=i||e?"text-amber-100/90":"text-emerald-900";return a.jsxs(m.div,{className:["db-scroll-egg-slot",J2[n.anchor]].join(" "),initial:o?{}:{opacity:0},animate:{opacity:1},transition:{delay:.85+l*.08,duration:.4},children:[a.jsx(m.button,{type:"button",className:["db-scroll-egg",n.hint&&"db-scroll-egg--hint",t.egg,t.eggHover,"border-0 bg-transparent font-serif"].join(" "),onClick:r=>{r.stopPropagation(),n.reveal&&(p(g=>!g),d==null||d())},"aria-expanded":h,"aria-label":n.reveal?`彩蛋：${n.text}`:n.text,children:n.text}),a.jsx(W,{children:h&&n.reveal&&a.jsx(m.p,{initial:{opacity:0,x:y?8:-8,filter:"blur(4px)"},animate:{opacity:1,x:0,filter:"blur(0px)"},exit:{opacity:0,x:y?6:-6},transition:{duration:.35},className:["db-scroll-egg-reveal",n.hint&&"db-scroll-egg-reveal--hint",u].join(" "),children:n.reveal})})]})}function K2({beat:n,isNight:t,onDark:e,morphPhase:i,onMorphComplete:l,enterFromMorph:c,letterEnterFromMorph:d}){const h=S(),p=i==="morph-jiang"&&n.id==="river",o=i==="morph-boat"&&n.id==="race",y=i==="morph-zongzi-seal"&&n.id==="festive";if(n.layout==="river-glyph")return a.jsx(g2,{beat:n,onDark:e,isNight:t,isExitingMorph:p,onMorphComplete:l});if(n.layout==="race-diagonal")return a.jsx(B2,{beat:n,onDark:e,isNight:t,enterFromMorph:c==="morph-jiang",isExitingMorph:o,onMorphComplete:l});if(n.layout==="festive-split")return a.jsx(X2,{beat:n,onDark:e,enterFromMorph:c==="morph-boat",isExitingMorph:y,onMorphComplete:l});const u=a.jsxs(l1,{className:["db-scene-layout--center",n.bodyVariant==="letter"?"db-scroll-content--letter":""].filter(Boolean).join(" "),variant:"stack",children:[a.jsx(a2,{text:n.display,mode:n.displayMode,onDark:e}),n.subtitle&&a.jsx(t2,{text:n.subtitle,onDark:e}),n.body&&n.body.length>0&&a.jsx(f1,{lines:n.body,onDark:e,variant:n.bodyVariant??"center"})]});return n.id==="letter"&&d?a.jsx(m.div,{className:"db-scene-layout-letter-enter",initial:h?!1:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.48,delay:.05,ease:[.22,1,.36,1]},children:u}):u}function n0({beat:n,isNight:t,theme:e,introComplete:i=!0,onUnrollComplete:l,morphPhase:c,onMorphComplete:d,enterFromMorph:h,onEggTap:p}){const o=S(),y=R1(n.material,t),u=n.material==="dawn"&&!t,r=G(n.material,t),g=n.layout!=="center",M=n.id==="prologue"&&!i&&!o,f=c==="morph-jiang"||c==="morph-boat"||c==="morph-ink"||c==="morph-zongzi-seal",b=c==="morph-ink"&&n.id==="prologue",j=s.useRef(h==="morph-zongzi-seal"&&!o).current,Z=c==="morph-jiang"&&n.id==="river"?G("race",t):c==="morph-boat"&&n.id==="race"?G("festive",t):c==="morph-zongzi-seal"&&n.id==="festive"?G("paper",t):null;return s.useEffect(()=>{if(!M||!l)return;const A=window.setTimeout(l,G2*1e3);return()=>window.clearTimeout(A)},[M,l]),a.jsxs("div",{className:["db-scroll-scene",n.material==="paper"?"db-scroll-scene--paper":"",g?"db-scroll-scene--layout":"",M?"db-scroll-scene--unrolling":"",f?"db-scroll-scene--morphing":"",u?"db-scroll-scene--dawn-day":"",n.id==="race"?"db-scroll-scene--race":"",n.id==="festive"?"db-scroll-scene--festive":""].join(" "),style:{background:r},role:"group","aria-roledescription":"slide","aria-label":`${n.display}${n.subtitle?`，${n.subtitle}`:""}`,children:[M&&a.jsx("div",{className:"db-scroll-unroll-edge","aria-hidden":!0}),a.jsx(Y2,{beat:n,isNight:t}),a.jsx(U2,{isNight:t,isExiting:b,onComplete:d}),Z&&a.jsx("div",{className:["db-morph-bg-crossfade pointer-events-none absolute inset-0 z-[1]",c==="morph-boat"?"db-morph-bg-crossfade--boat":"",c==="morph-jiang"?"db-morph-bg-crossfade--jiang":"",c==="morph-zongzi-seal"?"db-morph-bg-crossfade--letter":""].filter(Boolean).join(" "),style:{background:Z,animationDuration:c==="morph-boat"||c==="morph-jiang"||c==="morph-zongzi-seal"?void 0:`${K}ms`},"aria-hidden":!0}),a.jsx(l2,{chapter:n.chapter,sceneLabel:n.sceneLabel,onDark:y}),t&&n.material==="dawn"&&a.jsx("div",{className:"pointer-events-none absolute inset-x-0 top-0 h-1/2 opacity-60",style:{background:"radial-gradient(circle at 50% 0%, rgba(252,211,77,0.12) 0%, transparent 65%)"},"aria-hidden":!0}),!t&&n.material==="dawn"&&a.jsx("div",{className:"pointer-events-none absolute inset-x-0 top-0 h-2/3",style:{background:"radial-gradient(circle at 50% 0%, rgba(252,211,77,0.22) 0%, transparent 70%)"},"aria-hidden":!0}),n.material==="river"&&n.layout==="center"&&a.jsx(m.svg,{className:"pointer-events-none absolute inset-x-0 top-[16%] h-28 w-full opacity-25",viewBox:"0 0 400 40",preserveAspectRatio:"none","aria-hidden":!0,initial:o?{}:{x:"-4%"},animate:{x:"4%"},transition:{duration:8,repeat:1/0,repeatType:"reverse",ease:"easeInOut"},children:a.jsx("path",{d:"M0 25 Q100 8, 200 22 T400 18 L400 40 L0 40 Z",fill:t?"#065f46":"#98B5A8"})}),n.material==="paper"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-scroll-paper-texture pointer-events-none absolute inset-[8%] rounded-sm opacity-90","aria-hidden":!0}),a.jsx("div",{className:"db-scroll-paper-margin pointer-events-none absolute inset-y-[10%] left-[10%] w-px bg-stone-400/25","aria-hidden":!0})]}),a.jsx(K2,{beat:n,isNight:t,onDark:y,morphPhase:c,onMorphComplete:d,enterFromMorph:h,letterEnterFromMorph:j}),n.eggs.map((A,x)=>a.jsx(Q2,{egg:A,theme:e,onDark:y,isNight:t,index:x,hidden:f,onTap:p},A.id))]})}const a0=m.create(n0);function t0({visible:n,onDark:t=!0}){const e=S();return n?a.jsxs("div",{className:`db-scroll-hint ${t?"text-stone-300":"text-stone-600"}`,"aria-hidden":!0,children:[a.jsx(m.div,{className:"db-scroll-hint-chevron",animate:e?{}:{y:[0,6,0],opacity:[.5,1,.5]},transition:{duration:1.6,repeat:1/0,ease:"easeInOut"}}),a.jsx("span",{children:"向上滑动 · 滚轮展卷"})]}):null}function l0({index:n,visited:t,onSelect:e}){return a.jsx("nav",{className:"db-scroll-seals","aria-label":"长卷分幕",children:Q.map((i,l)=>{const c=l===n,d=t.has(l)&&!c;return a.jsx("button",{type:"button","aria-label":`${i.chapter} · ${i.sceneLabel}`,"aria-current":c?"step":void 0,onClick:()=>e(l),className:["db-scroll-seal",c?"db-scroll-seal--active":"",d?"db-scroll-seal--visited":""].filter(Boolean).join(" "),children:a.jsx("span",{className:"db-scroll-seal-face","aria-hidden":!0,children:i.chapter})},i.id)})})}function e0({pulse:n,direction:t,isNight:e}){if(S()||n===0)return null;const l=e?"linear-gradient(180deg, rgba(2,44,29,0) 0%, rgba(2,44,29,0.92) 45%, rgba(1,6,4,0.98) 100%)":"linear-gradient(180deg, rgba(74,100,88,0) 0%, rgba(42,66,56,0.75) 40%, rgba(2,44,29,0.88) 100%)";return a.jsx(W,{mode:"wait",children:a.jsx(m.div,{className:"db-transition-curtain",style:{background:l,transformOrigin:t>0?"50% 100%":"50% 0%"},initial:{scaleY:0,opacity:.6},animate:{scaleY:[0,1.05,0],opacity:[.5,.92,0]},exit:{opacity:0},transition:{duration:.78,ease:[.76,0,.24,1],times:[0,.42,1]},"aria-hidden":!0},n)})}const i0={enter:n=>({opacity:0,y:n>0?"14%":"-14%",scale:.92,filter:"blur(12px)"}),center:{opacity:1,y:0,scale:1,filter:"blur(0px)"},exit:n=>({opacity:0,y:n>0?"-22%":"22%",scale:1.04,filter:"blur(14px)"})},c0={duration:.72,ease:[.32,.72,0,1]},s0=42,d0=52,k1=820,h0=Math.max(...d2)+80,r0=new Set(["morph-ink","morph-jiang","morph-boat","morph-zongzi-seal"]);function p0(n){return!!n&&r0.has(n)}function f0({isNight:n,theme:t,onFirstAdvance:e,soundEnabled:i=!0}){const[l,c]=s.useState(0),[d,h]=s.useState(1),[p,o]=s.useState(!0),[y,u]=s.useState(0),[r,g]=s.useState(!1),[M,f]=s.useState(null),[b,k]=s.useState(null),[j,Z]=s.useState(null),[A,x]=s.useState(()=>new Set([0])),v=s.useRef(0),R=s.useRef(null),D=s.useRef(null),N=s.useRef(0),I=s.useRef(null),V=s.useRef(null),L=s.useRef(!1),z=s.useRef(0),X=S();s.useEffect(()=>{T.setMuted(!i)},[i]),s.useEffect(()=>{X&&g(!0)},[X]),s.useEffect(()=>{R.current=b,D.current=M},[b,M]),s.useEffect(()=>{x(w=>{const F=new Set(w);for(let q=0;q<=l;q++)F.add(q);return F});const C=z.current;l!==C&&l===4&&l>C&&T.playLetterOpen(),z.current=l},[l]),s.useEffect(()=>{if(!r)return;T.ensureReady();const C=()=>T.ensureReady();return window.addEventListener("pointerdown",C,{once:!0}),()=>window.removeEventListener("pointerdown",C)},[r]);const u1=s.useCallback(C=>{switch(C){case"morph-ink":T.playMorphInk();break;case"morph-jiang":T.playMorphWater();break;case"morph-boat":T.playMorphDrum();break;case"morph-zongzi-seal":T.playMorphSeal();break}},[]),Y=s.useCallback(C=>{var _;const w=Math.max(0,Math.min(G1-1,C));if(w===l||!r||M||Date.now()<v.current)return;const F=w>l?1:-1;if(h(F),F>0){const B=J1(l,w);if(B){f(B),k(w),u1(B),v.current=Date.now()+h0,N.current=0;return}}Z(null),(F>0&&((_=Q[l])==null?void 0:_.forwardTransition)==="light-curtain"||F<0)&&u(B=>B+1),c(w),v.current=Date.now()+k1,N.current=0,!L.current&&w>0&&(L.current=!0,o(!1),e==null||e())},[l,r,M,e,u1]),_1=s.useCallback(()=>{const C=R.current;if(C==null){f(null);return}const w=D.current;Z(w),c(C),k(null),f(null),v.current=Date.now()+k1,!L.current&&C>0&&(L.current=!0,o(!1),e==null||e()),requestAnimationFrame(()=>Z(null))},[e]),P=s.useCallback(()=>Y(l+1),[Y,l]),$=s.useCallback(()=>Y(l-1),[Y,l]),B1=s.useCallback(()=>{g(!0),T.playUnroll()},[]),E1=s.useCallback(()=>{T.playEggTap()},[]);s.useEffect(()=>{const C=V.current;if(!C)return;const w=F=>{F.preventDefault(),!(!r||M)&&(Date.now()<v.current||(N.current+=F.deltaY,!(Math.abs(N.current)<s0)&&(N.current>0?P():$(),N.current=0)))};return C.addEventListener("wheel",w,{passive:!1}),()=>C.removeEventListener("wheel",w)},[P,$,r,M]),s.useEffect(()=>{const C=V.current;if(!C)return;const w=q=>{var _;I.current=((_=q.touches[0])==null?void 0:_.clientY)??null},F=q=>{var m1;const _=I.current;if(I.current=null,_==null||!r||M)return;const B=(m1=q.changedTouches[0])==null?void 0:m1.clientY;if(B==null)return;const Z1=B-_;Math.abs(Z1)<d0||(Z1<0?P():$())};return C.addEventListener("touchstart",w,{passive:!0}),C.addEventListener("touchend",F,{passive:!0}),()=>{C.removeEventListener("touchstart",w),C.removeEventListener("touchend",F)}},[P,$,r,M]),s.useEffect(()=>{const C=w=>{!r||M||(w.key==="ArrowDown"||w.key==="PageDown"?(w.preventDefault(),P()):(w.key==="ArrowUp"||w.key==="PageUp")&&(w.preventDefault(),$()))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[P,$,r,M]),s.useEffect(()=>()=>T.stopAmbient(),[]);const e1=Q[l],O1=R1(e1.material,n),M1=p0(M),D1=X?{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.18}}:M1||(j==="morph-jiang"||j==="morph-boat"||j==="morph-ink"||j==="morph-zongzi-seal")?{initial:!1,animate:{opacity:1},exit:{opacity:1},transition:{duration:0}}:{custom:d,variants:i0,initial:"enter",animate:"center",exit:"exit",transition:c0};return a.jsxs("div",{ref:V,className:"relative h-full w-full overflow-hidden",tabIndex:0,"aria-live":"polite",children:[!M1&&a.jsx(e0,{pulse:y,direction:d,isNight:n}),a.jsx(W,{mode:"wait",custom:d,children:a.jsx(a0,{beat:e1,direction:d,isNight:n,theme:t,introComplete:r,onUnrollComplete:B1,morphPhase:M,onMorphComplete:_1,enterFromMorph:j,onEggTap:E1,...D1},e1.id)}),a.jsx(t0,{visible:p&&l===0&&r,onDark:O1}),a.jsx(l0,{index:l,visited:A,onSelect:Y})]})}const o0=""+new URL("ambient-BBYjlx1c.mp3",import.meta.url).href;function y0(){T.setAmbientSrc(o0)}function g0({theme:n,onBackToArchive:t,onBackToCabinet:e}){const i=!!(n!=null&&n.isNight),l=U1(i),[c,d]=s.useState(!0);return s.useEffect(()=>(I1(z1("festival-2026-DragonBoat")),y0(),()=>{T.dispose()}),[]),a.jsxs(P1,{id:"dragon-boat-scroll-root",className:"relative h-full min-h-0 overflow-hidden font-serif select-none [&_.viewport-main]:overflow-hidden [&_.viewport-main-inner]:h-full [&_.viewport-main-inner]:min-h-0",children:[a.jsx("div",{className:"pointer-events-none absolute inset-0 z-0",style:{background:i?"#0a2018":"#FCFBEB"},"aria-hidden":!0}),a.jsx("div",{className:"pointer-events-none absolute inset-x-0 top-0 z-[1] h-48 opacity-80",style:{background:l.sunAura},"aria-hidden":!0}),a.jsxs("header",{className:"pointer-events-auto absolute inset-x-0 top-0 z-30 flex items-center justify-between px-3 pb-1 pt-[max(0.5rem,env(safe-area-inset-top))] md:px-4",children:[a.jsx("div",{className:"flex items-center gap-2",children:e&&a.jsxs("button",{type:"button",onClick:e,className:`flex cursor-pointer items-center gap-1.5 rounded-full border px-3 py-1.5 font-serif text-xs font-bold transition-all active:scale-95 ${l.headerBtn}`,children:[a.jsx(X1,{className:"h-3.5 w-3.5 text-emerald-400"}),a.jsx("span",{children:"返回展柜"})]})}),a.jsxs("div",{className:"flex items-center",children:[t&&a.jsxs("button",{type:"button",onClick:t,className:"flex cursor-pointer items-center gap-1.5 rounded-full border border-emerald-700/40 bg-emerald-950/30 px-3 py-1.5 font-serif text-xs text-stone-300 transition-all hover:bg-emerald-900/50 hover:text-emerald-300 active:scale-95",children:[a.jsx(Y1,{className:"h-3.5 w-3.5 text-emerald-400"}),a.jsx("span",{children:"节日风物志"})]}),a.jsx("button",{type:"button",onClick:()=>d(h=>!h),className:`ml-2 flex cursor-pointer items-center justify-center rounded-full border p-2 transition-all active:scale-95 ${l.headerBtn}`,"aria-label":c?"关闭端午页音效":"开启端午页音效",title:c?"关闭音效":"开启音效",children:c?a.jsx($1,{className:"h-3.5 w-3.5 text-emerald-400"}):a.jsx(W1,{className:"h-3.5 w-3.5 text-stone-400"})})]})]}),a.jsx("main",{className:"relative z-10 h-full min-h-0 w-full flex-1",children:a.jsx(f0,{isNight:i,theme:l,soundEnabled:c})})]})}export{g0 as DragonBoatScroll};

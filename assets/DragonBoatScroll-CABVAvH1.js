...
想你的小胡
二零二六 五月初五`},b1=p1.content.split(/\n\n+/).map(n=>n.trim()).filter(Boolean),Q=[{id:"prologue",material:"dawn",chapter:"壹",sceneLabel:"引 · 展卷",layout:"center",displayMode:"vertical-pair",display:"蒲节记胜",subtitle:"2026 · 五月初五 · 竞渡长卷",body:["岁序走到重五，江风先热起来了"],forwardTransition:"morph-ink",eggs:[{id:"egg-prologue-hint",anchor:"top-right",text:"岁时记",reveal:"想和你一起过端午"}]},{id:"river",material:"river",chapter:"贰",sceneLabel:"江 · 远眺",layout:"river-glyph",displayMode:"horizontal",display:"江",subtitle:"天",body:["风从江面来，带着菖蒲与糯米的香气","南风知我意，流水寄相思"],bodyVariant:"asymmetric",forwardTransition:"morph-jiang",eggs:[{id:"egg-river-mist",anchor:"mid-left",text:"夹注 · 瓯江",hint:!0,reveal:"五叩粼粼江浪，自来一纸瓶笺"}]},{id:"race",material:"race",chapter:"叁",sceneLabel:"渡 · 鼓震",layout:"race-diagonal",displayMode:"horizontal",display:"渡",subtitle:"鼓声逐浪，心意同频",body:["三舟并渡，各怀节奏"],bodyVariant:"asymmetric",forwardTransition:"morph-boat",eggs:[{id:"egg-race-drum",anchor:"bottom-right",text:"鼓点三下",hint:!0,reveal:"三声鼓鸣，致我满心歉意"}]},{id:"festive",material:"festive",chapter:"肆",sceneLabel:"物 · 案上",layout:"festive-split",displayMode:"horizontal",display:"节物",subtitle:"案上岁时，掌上温良",body:["糯米裹成三角，咸甜各安其味","门悬艾蒲，兰汤祓禊，皆为长夏祈福","江上的热闹归于案头，想把满心温柔尽数写进书卷"],bodyVariant:"asymmetric",forwardTransition:"morph-zongzi-seal",eggs:[{id:"egg-festive-ai",anchor:"top-left",text:"艾",reveal:"艾香一缕，祝君温良无疾"},{id:"egg-festive-zong",anchor:"bottom-left",text:"粽",reveal:"一口糯香...算了不好消化，我们吃冰淇淋吧"}]},{id:"letter",material:"paper",chapter:"伍",sceneLabel:"寄情 · 展信",layout:"center",displayMode:"horizontal",display:p1.title,body:b1.length>0?b1:[p1.content],bodyVariant:"letter",eggs:[{id:"egg-letter-seal",anchor:"top-right",text:"印",reveal:"平生不会相思，才会相思，便害相思"}]},{id:"finale",material:"finale",chapter:"陆",sceneLabel:"收 · 记胜",layout:"center",displayMode:"finale",display:"永远「粽」意你",subtitle:"第一个端午节",body:["糯米成粽 艾菖辟邪 心心相扣 不负岁时韶华"],eggs:[{id:"egg-finale-story",anchor:"bottom-right",text:"Our Story",reveal:"日日念你 · 岁岁有你"}]}],a2=Q.length;function t2(n,t){var e;if(t!==n+1)return null;const i=(e=Q[n])==null?void 0:e.forwardTransition;return i==="morph-ink"||i==="morph-jiang"||i==="morph-boat"||i==="morph-zongzi-seal"?i:null}const T1=[.22,1,.36,1];function F1({char:n,index:t,reduceMotion:i,className:e}){return n===" "||n===`
`?a.jsx("span",{className:"inline-block w-[0.35em]","aria-hidden":!0}):i?a.jsx("span",{className:e,children:n}):a.jsx(m.span,{className:`db-ink-char inline-block ${e??""}`,style:{transformOrigin:"50% 100%",transformPerspective:600},initial:{opacity:0,y:36,rotateX:-52,filter:"blur(10px)"},animate:{opacity:1,y:0,rotateX:0,filter:"blur(0px)"},transition:{delay:.08+t*.07,duration:.62,ease:T1},children:n})}function l2({text:n,onDark:t,className:i}){const e=S(),l=[...n];return a.jsx("h2",{className:["db-ink-display db-ink-display--hero",t?"db-ink-display--on-dark":"db-ink-display--on-light",i].filter(Boolean).join(" "),"aria-label":n,children:l.map((c,d)=>a.jsx(F1,{char:c,index:d,reduceMotion:!!e},`${c}-${d}`))})}function e2({text:n,onDark:t}){const i=S(),e=Math.ceil(n.length/2),l=n.slice(0,e),c=n.slice(e);return a.jsx("div",{className:"db-ink-vertical-pair","aria-label":n,children:[l,c].map((d,h)=>a.jsx("div",{className:"db-ink-vertical-row",children:[...d].map((r,o)=>a.jsx(F1,{char:r,index:h*4+o,reduceMotion:!!i,className:t?"db-ink-display--on-dark":"db-ink-display--on-light"},`${h}-${r}-${o}`))},h))})}function i2({onDark:n}){const t=S(),i=["永","远","「","粽","」","意","你"];let e=0;return a.jsx("h2",{className:["db-ink-display db-ink-display--finale",n?"db-ink-display--on-dark":"db-ink-display--on-light"].join(" "),"aria-label":"永远粽意你",children:i.map(l=>{const c=e++,d=l==="粽";return t?a.jsx("span",{className:d?"db-zong-accent":void 0,children:l},l+c):a.jsx(m.span,{className:`db-ink-char inline-block ${d?"db-zong-accent":""}`,style:{transformOrigin:"50% 100%"},initial:{opacity:0,y:28,scale:d?.5:.85,filter:"blur(8px)"},animate:{opacity:1,y:0,scale:1,filter:"blur(0px)"},transition:{delay:.1+c*.09,duration:d?.75:.55,ease:T1},children:l},l+c)})})}function c2({text:n,mode:t="horizontal",onDark:i,className:e}){return t==="finale"?a.jsx(i2,{onDark:i}):t==="vertical-pair"?a.jsx(e2,{text:n,onDark:i}):a.jsx(l2,{text:n,onDark:i,className:e})}const r1=[.22,1,.36,1];function s2({text:n,onDark:t,delay:i=.42}){const e=S();return a.jsxs("div",{className:"db-ink-subtitle-wrap",children:[a.jsx(m.p,{className:["db-ink-subtitle",t?"text-stone-300":"text-stone-600"].join(" "),initial:e?{}:{opacity:0,y:14,letterSpacing:"0.2em"},animate:{opacity:1,y:0,letterSpacing:"0.08em"},transition:{delay:e?0:i,duration:.55,ease:r1},children:n}),a.jsx(m.div,{className:t?"db-ink-rule db-ink-rule--light":"db-ink-rule db-ink-rule--dark",initial:e?{scaleX:1}:{scaleX:0},animate:{scaleX:1},transition:{delay:e?0:i+.12,duration:.65,ease:r1},"aria-hidden":!0})]})}function f1({lines:n,onDark:t,variant:i="center",baseDelay:e=.52,exiting:l=!1,exitBaseDelay:c=0}){const d=S(),h=i==="letter",r=i==="asymmetric";return a.jsx("div",{className:["db-stagger-lines",h?"db-stagger-lines--letter":"",r?"db-stagger-lines--asymmetric":""].filter(Boolean).join(" "),children:n.map((o,y)=>{const u=h&&y===0,p=h&&y===n.length-1&&n.length>1;return a.jsx(m.p,{className:["db-stagger-line",t?"text-stone-200/95":"text-stone-700",h?"db-stagger-line--letter":"",u?"db-stagger-line--letter-salute":"",p?"db-stagger-line--letter-sign":""].join(" "),initial:d||l?!1:{opacity:0,x:h?24:r?-16:0,y:h?0:18,filter:"blur(5px)"},animate:l?{opacity:0,x:r?12:0,y:20,filter:"blur(6px)"}:{opacity:1,x:0,y:0,filter:"blur(0px)"},transition:l?{delay:d?0:c+y*.08,duration:.52,ease:[.4,0,.2,1]}:{delay:d?0:e+y*.14,duration:.58,ease:r1},children:o},`${o}-${y}`)})})}function d2({chapter:n,sceneLabel:t,onDark:i}){const e=S();return a.jsxs(a.Fragment,{children:[a.jsxs(m.div,{className:["db-scroll-frame",i?"db-scroll-frame--dark":"db-scroll-frame--light"].join(" "),initial:e?{}:{opacity:0},animate:{opacity:1},transition:{delay:.05,duration:.4},"aria-hidden":!0,children:[a.jsx("span",{className:"db-scroll-frame-corner db-scroll-frame-corner--tl"}),a.jsx("span",{className:"db-scroll-frame-corner db-scroll-frame-corner--tr"}),a.jsx("span",{className:"db-scroll-frame-corner db-scroll-frame-corner--bl"}),a.jsx("span",{className:"db-scroll-frame-corner db-scroll-frame-corner--br"})]}),a.jsx(m.div,{className:"db-scroll-chapter-mark",initial:e?{}:{opacity:0,x:-8},animate:{opacity:.22,x:0},transition:{delay:.2,duration:.5},"aria-hidden":!0,children:n}),a.jsx(m.p,{className:["db-scroll-scene-label",i?"text-stone-400/60":"text-stone-500/55"].join(" "),initial:e?{}:{opacity:0},animate:{opacity:1},transition:{delay:.55,duration:.45},children:t})]})}function g1(n){return n?"linear-gradient(180deg, transparent 0%, rgba(15,42,34,0.08) 18%, rgba(6,78,59,0.22) 48%, rgba(2,44,29,0.38) 78%, rgba(2,44,29,0.48) 100%)":"linear-gradient(180deg, transparent 0%, rgba(214,230,222,0.22) 22%, rgba(152,181,168,0.32) 52%, rgba(74,100,88,0.28) 82%, rgba(74,100,88,0.36) 100%)"}function h2(n){return n?"radial-gradient(ellipse 70% 65% at 50% 55%, rgba(180,120,70,0.42) 0%, rgba(90,55,30,0.18) 42%, transparent 72%)":"radial-gradient(ellipse 70% 65% at 50% 55%, rgba(210,165,105,0.38) 0%, rgba(160,110,65,0.16) 40%, transparent 72%)"}const t1=820,p2=Math.round(t1*.68),A1=t1/1e3,x1=[.38,.02,.18,1],K=880,r2=Math.round(K*.72),a1=1050,o1=680,f2=Math.round(o1*.7),o2=[t1,K,a1,o1],y2=14,C1=18;function u2({className:n,isNight:t=!1,onWaterTap:i,interactive:e=!0}){const[l,c]=s.useState([]),d=s.useRef(0),h=s.useRef(null),r=s.useRef(null),o=s.useCallback((f,b,k)=>{const j=h.current;if(!j)return;const Z=j.getBoundingClientRect(),A=(f-Z.left)/Z.width*100,x=(b-Z.top)/Z.height*100,v=++d.current;c(T=>[...T.slice(-9),{id:v,x:A,y:x}]),k&&(i==null||i({x:A,y:x})),window.setTimeout(()=>{c(T=>T.filter(I=>I.id!==v))},1400)},[i]),y=f=>{e&&(r.current={startX:f.clientX,startY:f.clientY,maxMove:0,lastRippleX:f.clientX,lastRippleY:f.clientY},f.currentTarget.setPointerCapture(f.pointerId))},u=f=>{if(!e)return;const b=r.current;if(!b||f.buttons===0&&f.pressure===0)return;const k=f.clientX-b.startX,j=f.clientY-b.startY;b.maxMove=Math.max(b.maxMove,Math.hypot(k,j));const Z=f.clientX-b.lastRippleX,A=f.clientY-b.lastRippleY;Z*Z+A*A<C1*C1||(b.lastRippleX=f.clientX,b.lastRippleY=f.clientY,o(f.clientX,f.clientY,!1))},p=f=>{if(!e)return;const b=r.current;r.current=null,f.currentTarget.hasPointerCapture(f.pointerId)&&f.currentTarget.releasePointerCapture(f.pointerId),b&&b.maxMove<=y2&&o(f.clientX,f.clientY,!0)},g=f=>p(f),M=f=>p(f);return a.jsx("div",{ref:h,className:["db-river-ripple-surface",t?"db-river-ripple-surface--night":"db-river-ripple-surface--day",n].filter(Boolean).join(" "),onPointerDown:y,onPointerMove:u,onPointerUp:g,onPointerCancel:M,"aria-hidden":e?void 0:!0,children:l.map(f=>a.jsx("span",{className:"db-river-ripple",style:{left:`${f.x}%`,top:`${f.y}%`}},f.id))})}var N1=W1();const M2=`我猜这个彩蛋你发现不了，所以偷偷记录一点放肆的话。
超级超级喜欢你！
每天都很想见你！
真的很希望我能让你喜欢
总之我会努力做的更好的
希望正式和你在一起的那一天不太遥远`,Z2=5,O=-28,m2="dragon-boat-scroll-root";function b2(){return document.getElementById(m2)??document.body}function v1({isNight:n,submerged:t=!1}){const i=t?n?"rgba(6, 78, 59, 0.35)":"rgba(16, 120, 90, 0.32)":n?"rgba(134, 239, 172, 0.28)":"rgba(167, 243, 208, 0.48)",e=t?n?"rgba(2, 44, 34, 0.72)":"rgba(4, 72, 55, 0.58)":n?"rgba(6, 78, 59, 0.58)":"rgba(52, 211, 153, 0.32)",l=t?n?"rgba(94, 234, 212, 0.28)":"rgba(167, 243, 208, 0.35)":n?"rgba(167, 243, 208, 0.62)":"rgba(255, 255, 255, 0.78)";return a.jsxs("svg",{className:"db-drift-bottle-svg",viewBox:"0 0 64 104",fill:"none",xmlns:"http://www.w3.org/2000/svg","aria-hidden":!0,children:[a.jsx("path",{d:"M32 37 C17.5 37 13.5 54 13.5 72.5 C13.5 89 19.5 97 32 97 C44.5 97 50.5 89 50.5 72.5 C50.5 54 46.5 37 32 37Z",fill:e,stroke:l,strokeWidth:"1.2"}),a.jsx("path",{d:"M32 37 C22 37 18 50 18 68 C18 82 22 90 32 90 C42 90 46 82 46 68 C46 50 42 37 32 37Z",fill:i}),a.jsx("path",{d:"M26.5 37 L26.5 17.5 C26.5 13.5 28.5 11.5 32 11.5 C35.5 11.5 37.5 13.5 37.5 17.5 L37.5 37",fill:e,stroke:l,strokeWidth:"1"}),!t&&a.jsxs(a.Fragment,{children:[a.jsx("rect",{x:"24.5",y:"3.5",width:"15",height:"9.5",rx:"2.5",fill:"#c9a66b",stroke:"#8b6914",strokeWidth:"0.8"}),a.jsx("rect",{x:"23",y:"2",width:"18",height:"3",rx:"1.2",fill:"#a8844a"})]}),t&&a.jsx("rect",{x:"24.5",y:"3.5",width:"15",height:"9.5",rx:"2.5",fill:"#7a6344",stroke:"#4a3818",strokeWidth:"0.8",opacity:"0.55"}),a.jsx("rect",{x:"22",y:"54",width:"20",height:"26",rx:"1.5",fill:t?"#d4c4a0":"#fef3c7",stroke:"#d6c4a0",strokeWidth:"0.6",transform:"rotate(-10 32 67)",opacity:t?.55:.92}),!t&&a.jsx("path",{d:"M24 58 L28 56 L30 78 L26 80Z",fill:"#fde68a",opacity:"0.5",transform:"rotate(-10 32 67)"}),!t&&a.jsx("path",{d:"M21 48 Q19 70 23 88",stroke:"rgba(255,255,255,0.42)",strokeWidth:"1.8",strokeLinecap:"round"}),!t&&a.jsx("path",{d:"M28 14 C30 15 34 15 36 14",stroke:"#8b6914",strokeWidth:"0.8",strokeLinecap:"round",opacity:"0.6"})]})}function g2({isNight:n}){return a.jsxs("span",{className:"db-drift-bottle-figure","aria-hidden":!0,children:[a.jsx("span",{className:"db-drift-bottle-half db-drift-bottle-half--below",children:a.jsx(v1,{isNight:n,submerged:!0})}),a.jsx("span",{className:"db-drift-bottle-surface-line"}),a.jsx("span",{className:"db-drift-bottle-half db-drift-bottle-half--above",children:a.jsx(v1,{isNight:n})})]})}function A2({spot:n,phase:t,isNight:i=!1,onBottleClick:e,onClosePaper:l,onRiseComplete:c,onSinkComplete:d}){const h=S();if(s.useEffect(()=>{if(t!=="rising")return;if(h){c();return}const p=window.setTimeout(c,780);return()=>window.clearTimeout(p)},[t,h,c]),s.useEffect(()=>{t!=="sinking"||!h||d()},[t,h,d]),!n||t==="hidden")return null;const r={left:`${n.x}%`,top:`${n.y}%`},o=t==="rising"||t==="floating"||t==="sinking",y=t==="paper",u=typeof document<"u"?N1.createPortal(a.jsx(W,{children:y&&a.jsxs(a.Fragment,{children:[a.jsx(m.button,{type:"button",className:"db-drift-bottle-backdrop",initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:l,"aria-label":"收起纸团"},"drift-bottle-backdrop"),a.jsxs(m.div,{className:"db-drift-bottle-paper",role:"dialog","aria-modal":"true","aria-labelledby":"drift-bottle-paper-text",initial:h?{opacity:1,scale:1,x:"-50%",y:"-50%"}:{opacity:0,scale:.88,x:"-50%",y:"calc(-50% + 12px)"},animate:{opacity:1,scale:1,x:"-50%",y:"-50%"},exit:{opacity:0,scale:.92,x:"-50%",y:"calc(-50% + 8px)"},transition:{duration:.42,ease:[.22,1,.36,1]},children:[a.jsx("div",{className:"db-drift-bottle-paper-body",children:a.jsx("p",{id:"drift-bottle-paper-text",className:"db-drift-bottle-paper-text",children:M2})}),a.jsx("button",{type:"button",className:"db-drift-bottle-paper-close",onClick:l,children:"收起"})]},"drift-bottle-paper")]})}),b2()):null;return a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-drift-bottle-layer",style:r,children:a.jsx(W,{mode:"wait",children:o&&a.jsxs(m.button,{type:"button",className:"db-drift-bottle",initial:h?{opacity:1,y:0,scale:1,rotate:O}:{opacity:0,y:28,scale:.82,rotate:O-6},animate:t==="sinking"?{opacity:0,y:36,scale:.65,rotate:O+10}:t==="rising"?{opacity:1,y:0,scale:1,rotate:O}:{opacity:1,y:[0,-3,0],scale:1,rotate:[O+2,O-2,O+2]},exit:{opacity:0,y:32,scale:.6,rotate:O+8},style:{transformOrigin:"50% 50%"},transition:t==="sinking"?{duration:.85,ease:[.45,.05,.55,.95]}:t==="rising"?{duration:.75,ease:[.22,1,.36,1]}:{y:{duration:2.8,repeat:1/0,ease:"easeInOut"},rotate:{duration:3.2,repeat:1/0,ease:"easeInOut"}},onAnimationComplete:()=>{t==="sinking"&&!h&&d()},onClick:p=>{t==="floating"&&(p.stopPropagation(),e())},disabled:t!=="floating","aria-label":"拾取漂流瓶",children:[a.jsx("span",{className:"db-drift-bottle-ring","aria-hidden":!0}),a.jsx(g2,{isNight:i})]},"bottle")})}),u]})}const x2=""+new URL("drums-BnD5tEc6.mp3",import.meta.url).href,C2=5e3;class v2{constructor(){this.ctx=null,this.isMuted=!1,this.bgmAudio=null,this.drumAudio=null,this.bgmIntervalId=null,this.bgmRestartTimer=null,this.bgmEndedHandler=null,this.ambientSrc=null}initContext(){var t;if(!this.ctx){const i=window.AudioContext||window.webkitAudioContext;i&&(this.ctx=new i)}((t=this.ctx)==null?void 0:t.state)==="suspended"&&this.ctx.resume()}setMuted(t){this.isMuted=t,t?this.stopAmbient():this.startAmbient()}getMuted(){return this.isMuted}setAmbientSrc(t){this.ambientSrc!==t&&(this.clearBgmAudio(),this.ambientSrc=t)}clearBgmRestartTimer(){this.bgmRestartTimer&&(clearTimeout(this.bgmRestartTimer),this.bgmRestartTimer=null)}clearBgmAudio(){this.clearBgmRestartTimer(),this.bgmAudio&&this.bgmEndedHandler&&this.bgmAudio.removeEventListener("ended",this.bgmEndedHandler),this.bgmEndedHandler=null,this.bgmAudio&&(this.bgmAudio.pause(),this.bgmAudio.currentTime=0,this.bgmAudio=null)}ensureBgmAudio(){if(!this.ambientSrc)return null;if(this.bgmAudio)return this.bgmAudio;const t=new Audio(this.ambientSrc);return t.volume=.22,t.loop=!1,this.bgmEndedHandler=()=>{this.isMuted||!this.ambientSrc||(this.clearBgmRestartTimer(),this.bgmRestartTimer=setTimeout(()=>{this.bgmRestartTimer=null,!(this.isMuted||!this.bgmAudio)&&(this.bgmAudio.currentTime=0,this.bgmAudio.play().catch(()=>{}))},C2))},t.addEventListener("ended",this.bgmEndedHandler),this.bgmAudio=t,t}tone(t,i,e="sine",l=.08,c=0){if(this.isMuted||!this.ctx)return;const d=this.ctx.currentTime+c,h=this.ctx.createOscillator(),r=this.ctx.createGain();h.type=e,h.frequency.setValueAtTime(t,d),r.gain.setValueAtTime(0,d),r.gain.linearRampToValueAtTime(l,d+.02),r.gain.exponentialRampToValueAtTime(.001,d+i),h.connect(r),r.connect(this.ctx.destination),h.start(d),h.stop(d+i+.05)}noiseBurst(t,i=.04,e=800,l=0){if(this.isMuted||!this.ctx)return;const c=this.ctx.currentTime+l,d=Math.floor(this.ctx.sampleRate*t),h=this.ctx.createBuffer(1,d,this.ctx.sampleRate),r=h.getChannelData(0);for(let p=0;p<d;p++)r[p]=(Math.random()*2-1)*(1-p/d);const o=this.ctx.createBufferSource();o.buffer=h;const y=this.ctx.createBiquadFilter();y.type="lowpass",y.frequency.setValueAtTime(e,c);const u=this.ctx.createGain();u.gain.setValueAtTime(i,c),u.gain.exponentialRampToValueAtTime(.001,c+t),o.connect(y),y.connect(u),u.connect(this.ctx.destination),o.start(c),o.stop(c+t)}ensureReady(){this.isMuted||(this.initContext(),this.startAmbient())}playUnroll(){this.isMuted||(this.initContext(),this.noiseBurst(.35,.035,1200),this.tone(180,.25,"triangle",.05),this.tone(120,.4,"sine",.03,.08))}playMorphWater(){this.isMuted||(this.initContext(),this.noiseBurst(.55,.05,600),this.tone(220,.3,"sine",.04),this.tone(165,.45,"triangle",.03,.12))}playMorphDrum(){this.isMuted||(this.initContext(),[0,.18,.36].forEach(t=>{this.tone(90,.12,"sine",.1,t),this.noiseBurst(.08,.025,400,t)}))}playMorphInk(){this.isMuted||(this.initContext(),this.noiseBurst(.5,.03,300),this.tone(80,.6,"triangle",.06))}playMorphSeal(){this.isMuted||(this.initContext(),this.tone(440,.08,"sine",.06),this.tone(330,.15,"triangle",.05,.06),this.noiseBurst(.12,.02,2e3,.1))}playRaceDrum(){if(this.isMuted)return;this.initContext(),this.drumAudio||(this.drumAudio=new Audio(x2),this.drumAudio.volume=.62);const t=this.drumAudio.cloneNode(!0);t.volume=this.drumAudio.volume,t.play().catch(()=>{})}playEggTap(){this.isMuted||(this.initContext(),this.tone(520,.06,"sine",.07),this.tone(780,.1,"triangle",.04,.04))}playLetterOpen(){this.isMuted||(this.initContext(),this.noiseBurst(.2,.03,1500),this.tone(260,.2,"sine",.05),this.tone(196,.35,"triangle",.03,.1))}playSynthAmbientNote(t,i,e){if(this.isMuted||!this.ctx)return;const l=this.ctx.currentTime+e,c=this.ctx.createOscillator(),d=this.ctx.createGain();c.type="sine",c.frequency.setValueAtTime(t,l),d.gain.setValueAtTime(0,l),d.gain.linearRampToValueAtTime(.018,l+.15),d.gain.exponentialRampToValueAtTime(.001,l+i),c.connect(d),d.connect(this.ctx.destination),c.start(l),c.stop(l+i)}startAmbient(){if(this.isMuted)return;if(this.initContext(),this.ambientSrc){const l=this.ensureBgmAudio();if(!l)return;l.play().catch(()=>{});return}if(this.bgmIntervalId||!this.ctx)return;const t=[261.63,293.66,329.63,392,440];let i=0;const e=()=>{if(!(!this.ctx||this.isMuted)){for(let l=0;l<3;l++){const c=t[(i+l)%t.length];this.playSynthAmbientNote(c,2.8,l*1.4)}i=(i+3)%t.length}};e(),this.bgmIntervalId=setInterval(e,4200)}stopAmbient(){this.bgmIntervalId&&(clearInterval(this.bgmIntervalId),this.bgmIntervalId=null),this.clearBgmRestartTimer(),this.bgmAudio&&(this.bgmAudio.pause(),this.bgmAudio.currentTime=0)}dispose(){var t;this.stopAmbient(),this.clearBgmAudio(),this.ambientSrc=null,(t=this.ctx)==null||t.close(),this.ctx=null}}const R=new v2;function l1({children:n,className:t,variant:i="stack"}){return a.jsx("div",{className:["db-scene-layout",`db-scene-layout--${i}`,t].filter(Boolean).join(" "),children:n})}function w2({beat:n,onDark:t,isNight:i,isExitingMorph:e=!1,onMorphComplete:l}){const c=S(),d=s.useRef(!1),[,h]=s.useState(0),[r,o]=s.useState(null),[y,u]=s.useState("hidden"),[p,g]=s.useState(!1),M=s.useCallback(()=>{!e||d.current||(d.current=!0,l==null||l())},[e,l]);s.useEffect(()=>{if(!e){d.current=!1;return}if(c){M();return}const x=window.setTimeout(M,p2),v=window.setTimeout(M,t1+80);return()=>{window.clearTimeout(x),window.clearTimeout(v)}},[e,c,M]);const f=!e&&!p&&y==="hidden",b=s.useCallback(x=>{f&&h(v=>{const T=v+1;return T>=Z2&&(o(x),u("rising")),T})},[f]),k=s.useCallback(()=>{u(x=>x==="rising"?"floating":x)},[]),j=s.useCallback(()=>{u("paper"),R.playEggTap()},[]),Z=s.useCallback(()=>{u("sinking")},[]),A=s.useCallback(()=>{u("hidden"),o(null),g(!0)},[]);return a.jsxs(l1,{className:"db-layout-river-glyph",variant:"stack",children:[a.jsxs("div",{className:"db-layout-river-glyph-water",children:[a.jsx(u2,{className:"db-layout-river-glyph-ripples",isNight:i,onWaterTap:b,interactive:f}),a.jsx(A2,{spot:r,phase:y,isNight:i,onBottleClick:j,onClosePaper:Z,onRiseComplete:k,onSinkComplete:A})]}),a.jsxs("div",{className:"db-layout-river-glyph-hero",children:[a.jsx("h2",{className:["db-river-glyph-main",t?"db-ink-display--on-dark":""].join(" "),"aria-label":"江天",children:a.jsx(m.span,{className:"db-river-glyph-char",style:{transformOrigin:"50% 0%"},initial:c?!1:{opacity:0,y:"40%",scaleY:1.6,scaleX:.85,filter:"blur(8px)"},animate:e?{opacity:0,y:"120%",scaleY:2.3,scaleX:.7,filter:"blur(0px)"}:{opacity:1,y:0,scaleY:1,scaleX:1,filter:"blur(0px)"},transition:e?{duration:A1,ease:x1,delay:0}:{duration:.75,ease:[.22,1,.36,1]},children:"江"})}),n.subtitle&&a.jsx(m.span,{className:"db-river-glyph-corner",initial:c?!1:{opacity:0,y:-8},animate:e?{opacity:0,y:-14,scaleY:1.35,scaleX:.88}:{opacity:.75,y:0,scaleY:1,scaleX:1},transition:e?{duration:.42,delay:.04,ease:x1}:{delay:.42,duration:.45,ease:[.22,1,.36,1]},style:{transformOrigin:"50% 0%"},children:n.subtitle})]}),n.body&&n.body.length>0&&a.jsx("div",{className:"db-layout-river-glyph-body",children:a.jsx(f1,{lines:n.body,onDark:t,variant:"asymmetric",exiting:e,exitBaseDelay:0})}),a.jsx(m.div,{className:"db-layout-river-glyph-wave",style:{background:g1(i)},"aria-hidden":!0,initial:!1,animate:e?{opacity:0,x:"0%"}:{opacity:1,x:["-2%","2%","-2%"]},transition:e?{duration:.38,ease:[.4,0,.2,1]}:{duration:10,repeat:1/0,ease:"easeInOut"}}),e&&a.jsx(m.div,{className:"db-layout-river-glyph-wash",style:{background:g1(i)},initial:{opacity:0,scaleY:.35},animate:{opacity:.82,scaleY:1},transition:{duration:A1*.85,delay:.08,ease:[.32,.72,0,1]},"aria-hidden":!0})]})}const S2=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   viewBox="0 0 750 500"
   version="1.1"
   id="svg289"
...
`,j2=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   viewBox="0 0 750 500"
   version="1.1"
   id="svg289"
...
`,R2=S2,T2=j2,F2=k2,N2={3:R2,2:T2,1:F2};function L1({index:n,label:t="近舟",isNight:i,showLabel:e=!1,morphLite:l=!1,rowBurst:c=!1,hitTargetRef:d}){const h=N2[n],r=n===1?"0.9s":"1.15s",o=n===1?"0.6s":"0.77s",y=c?"0.28s":"0.55s",u=c?o:r,p=`
  ...
  `,g=a.jsx("div",{ref:d,className:`db-boat-svg-hit-target pointer-events-none flex h-full w-full items-center justify-end [&>svg]:h-full [&>svg]:w-full [&>svg]:overflow-visible ${i?"brightness-110":""}`,dangerouslySetInnerHTML:{__html:h}});return a.jsxs("div",{className:[`relative flex h-full w-full flex-col items-center justify-end boat-container-${n}`,l?"boat-container--lite":"",c?"boat-container--row-burst":""].filter(Boolean).join(" "),style:{"--row-duration":u,"--drum-duration":y},children:[a.jsx("style",{children:p}),e&&a.jsx("span",{className:"pointer-events-none absolute -top-4 select-none rounded border border-amber-900/30 bg-black/45 px-1 py-0.5 font-serif text-[7px] text-amber-200",children:t}),l?g:a.jsx(m.div,{className:"pointer-events-none h-full w-full",animate:{y:[-1,1,-1],rotate:[-.4,.4,-.4]},transition:{duration:n===1?.95:1.25,repeat:1/0,ease:"easeInOut"},children:g})]})}function L2(n){const e=(n.querySelector("svg")??n).getBoundingClientRect();return e.width<4||e.height<4?null:{left:e.left,top:e.top,width:e.width,height:e.height}}function q2({hitTargetRef:n,onTap:t,disabled:i=!1,isNight:e=!1}){const[l,c]=s.useState(null),[d,h]=s.useState([]),r=s.useRef(null),o=s.useRef(0),y=s.useRef(0),[u,p]=s.useState(null);s.useEffect(()=>{p(document.getElementById("dragon-boat-scroll-root"))},[]);const g=()=>{const Z=n.current;if(!Z||i){c(null);return}c(L2(Z))};s.useLayoutEffect(()=>{if(g(),i)return;const Z=n.current,A=Z?new ResizeObserver(g):null;A==null||A.observe(Z);let x=0;const v=()=>{g(),x=requestAnimationFrame(v)};return x=requestAnimationFrame(v),window.addEventListener("resize",g),()=>{A==null||A.disconnect(),cancelAnimationFrame(x),window.removeEventListener("resize",g)}},[n,i]);const M=(Z,A)=>{const x=++y.current;h(v=>[...v.slice(-5),{id:x,x:Z,y:A}]),window.setTimeout(()=>{h(v=>v.filter(T=>T.id!==x))},950)},f=(Z,A)=>{const x=Date.now();x-o.current<100||(o.current=x,M(Z,A),t())},b=Z=>{r.current={x:Z.clientX,y:Z.clientY},Z.stopPropagation()},k=Z=>{Z.stopPropagation();const A=r.current;if(r.current=null,!A)return;const x=Z.clientX-A.x,v=Z.clientY-A.y;Math.hypot(x,v)>18||f(Z.clientX,Z.clientY)};if(i||!u||!l)return null;const j=e?"db-race-drum-wave--night":"db-race-drum-wave--day";return N1.createPortal(a.jsxs(a.Fragment,{children:[d.map(Z=>a.jsxs("span",{className:["db-race-drum-wave",j].join(" "),style:{left:Z.x,top:Z.y},"aria-hidden":!0,children:[a.jsx("span",{className:"db-race-drum-wave__ring"}),a.jsx("span",{className:"db-race-drum-wave__ring db-race-drum-wave__ring--delay-1"}),a.jsx("span",{className:"db-race-drum-wave__ring db-race-drum-wave__ring--delay-2"})]},Z.id)),a.jsx("button",{type:"button",className:"db-race-drum-hit db-race-drum-hit--portal",style:{position:"fixed",left:l.left,top:l.top,width:l.width,height:l.height},onPointerDown:b,onPointerUp:k,"aria-label":"敲鼓"})]}),u)}const i1=5e3,w1=1.35,c1=.9,n1=1200,E=[{segments:["临时加了这个part，","也是为我最近不好的状态说声抱歉"],partGaps:[0,880],startOffset:0,fadeStagger:0,placement:{left:"6%",top:"48%",maxWidth:"min(78vw, 17.5rem)",rotate:-2.1,textAlign:"left"}},{segments:["很抱歉最近事情很多，","连开假条的时间都忘了"],partGaps:[0,720],startOffset:2900,fadeStagger:820,placement:{right:"7%",top:"57%",maxWidth:"min(72vw, 16rem)",rotate:1.6,textAlign:"right",transformOrigin:"100% 50%"}},{segments:["在你情绪不好的时候，没能给你一些依靠"],partGaps:[0],startOffset:5400,fadeStagger:1680,placement:{left:"11%",top:"66%",maxWidth:"min(70vw, 15.5rem)",rotate:-.9,textAlign:"left"}},{segments:["我还不够细心周到，","但我会不断努力的"],partGaps:[0,1040],startOffset:7600,fadeStagger:2540,placement:{left:"19%",top:"76%",maxWidth:"min(68vw, 15rem)",rotate:1.3,textAlign:"left"}}];function H2({active:n,isNight:t}){const i=S(),[e,l]=s.useState(()=>E.map(()=>({visibleParts:0,fading:!1,gone:!1}))),c=s.useRef(0);return s.useEffect(()=>{if(!n){c.current+=1,l(E.map(()=>({visibleParts:0,fading:!1,gone:!1})));return}const d=c.current+1;c.current=d;const h=[],r=(p,g)=>{c.current===d&&l(M=>M.map((f,b)=>b===p?{...f,...g}:f))};if(i)return h.push(window.setTimeout(()=>{l(E.map(p=>({visibleParts:p.segments.length,fading:!1,gone:!1})))},n1)),h.push(window.setTimeout(()=>{E.forEach((p,g)=>r(g,{fading:!0}))},n1+i1)),h.push(window.setTimeout(()=>{E.forEach((p,g)=>r(g,{gone:!0,visibleParts:0}))},n1+i1+c1*1e3)),()=>h.forEach(p=>window.clearTimeout(p));const o=[];E.forEach((p,g)=>{let M=n1+p.startOffset;p.segments.forEach((f,b)=>{b>0&&(M+=p.partGaps[b]??800),h.push(window.setTimeout(()=>{r(g,{visibleParts:b+1,fading:!1,gone:!1})},M))}),o.push(M+w1*1e3)});const u=Math.max(...o)+i1;return E.forEach((p,g)=>{const M=u+p.fadeStagger;h.push(window.setTimeout(()=>{r(g,{fading:!0})},M)),h.push(window.setTimeout(()=>{r(g,{fading:!1,gone:!0,visibleParts:0})},M+c1*1e3))}),()=>h.forEach(p=>window.clearTimeout(p))},[n,i]),n?a.jsx("div",{className:["db-race-water-whispers",t?"db-race-water-whispers--night":""].join(" "),"aria-hidden":!0,children:E.map((d,h)=>{const r=e[h];if(r.gone&&r.visibleParts===0)return null;const{placement:o}=d;return a.jsx(m.p,{className:"db-race-water-whisper-line",style:{left:o.left,right:o.right,top:o.top,maxWidth:o.maxWidth,textAlign:o.textAlign??"left",transform:`rotate(${o.rotate}deg)`,transformOrigin:o.transformOrigin??"0 50%"},initial:!1,animate:{opacity:r.fading?0:1},transition:{duration:i?0:r.fading?c1:.6,ease:"easeOut"},children:d.segments.map((y,u)=>a.jsx(m.span,{className:"db-race-water-whisper-part",initial:!1,animate:{opacity:r.visibleParts>u?1:0},transition:{duration:i?0:w1,ease:[.22,1,.36,1]},children:y},u))},h)})}):null}const S1=K/1e3,_2=[.38,.02,.18,1],B2=3200,y1=3.6,O2=Math.round(y1*1e3)+80,E2=280,q1=[0,.45,.45,1],H1=[.42,0,.58,1],I2=118,D2="-118vw";function s1(n){if(!n)return 0;const t=n.style.transform||window.getComputedStyle(n).transform;if(!t||t==="none")return 0;const i=t.match(/matrix\(([^)]+)\)/);if(!i)return 0;const e=i[1].split(",").map(l=>parseFloat(l.trim()));return e.length<6||Number.isNaN(e[4])?0:e[4]/window.innerWidth*100}function d1(n){const t=n+I2;return[`${n}vw`,`${t}vw`,D2,"0vw"]}function j1({classSuffix:n,boatIndex:t,isNight:i,isExitingMorph:e,driftDuration:l,baseOpacity:c,rowBurst:d,burstPath:h,boatRef:r}){const o=S(),y=d&&h!==null;return a.jsx(m.div,{ref:r,className:`db-layout-race-far db-layout-race-far--${n}`,initial:!1,animate:e?{opacity:0,x:"16vw",y:"-2%"}:y?{opacity:c,x:h,y:0}:o?{opacity:c,x:0,y:0}:{opacity:c,x:["-5vw","6vw"],y:[0,"-1.2%",0]},transition:e?{duration:.5,ease:[.4,0,.2,1]}:y?{duration:y1,ease:H1,times:[...q1]}:o?{duration:0}:{duration:l,repeat:1/0,repeatType:"mirror",ease:"easeInOut"},children:a.jsx(L1,{index:t,isNight:i,showLabel:!1,morphLite:e,rowBurst:d&&!e})})}function z2({beat:n,onDark:t,isNight:i,enterFromMorph:e,isExitingMorph:l=!1,onMorphComplete:c}){const d=S(),r=s.useRef(e&&!d).current,o=s.useRef(!1),[y,u]=s.useState(!1),[p,g]=s.useState(null),M=s.useRef(0),f=s.useRef(null),b=s.useRef(null),k=s.useRef(null),j=s.useRef(null),Z=s.useRef(null),A=s.useRef(null),x=s.useRef(null),v=s.useRef(!1),[T,I]=s.useState(!1),N=s.useCallback(()=>{!l||o.current||(o.current=!0,c==null||c())},[l,c]);s.useEffect(()=>{if(!l){o.current=!1;return}if(d){N();return}const L=window.setTimeout(N,r2),z=window.setTimeout(N,K+100);return()=>{window.clearTimeout(L),window.clearTimeout(z)}},[l,d,N]),s.useEffect(()=>()=>{f.current&&window.clearTimeout(f.current),b.current&&window.clearTimeout(b.current),k.current&&window.clearTimeout(k.current)},[]);const D=s.useCallback(()=>{if(d||l)return;const L=s1(j.current),z=s1(Z.current),X=s1(A.current);g({near:d1(L),far1:d1(z),far2:d1(X)}),u(!0),b.current&&window.clearTimeout(b.current),b.current=window.setTimeout(()=>{u(!1),g(null)},O2)},[d,l]),V=s.useCallback(()=>{if(R.ensureReady(),R.playRaceDrum(),M.current+=1,M.current>=3){M.current=0,f.current&&window.clearTimeout(f.current),k.current&&window.clearTimeout(k.current),v.current||(v.current=!0,I(!0)),k.current=window.setTimeout(()=>{D(),k.current=null},E2);return}f.current&&window.clearTimeout(f.current),f.current=window.setTimeout(()=>{M.current=0},B2)},[D]);return a.jsxs(l1,{className:"db-layout-race-diagonal",variant:"stage",children:[a.jsxs("div",{className:"db-layout-race-diagonal-copy",children:[a.jsx("h2",{className:["db-ink-display db-ink-display--hero db-layout-race-title",t?"db-ink-display--on-dark":"db-ink-display--on-light"].join(" "),children:a.jsx(m.span,{className:"db-race-title-char",style:{transformOrigin:"50% 100%",display:"inline-block"},initial:r?{opacity:.6,x:-12}:d?!1:{opacity:0,y:28},animate:l?{opacity:0,x:-12,y:-8}:{opacity:1,x:0,y:0},transition:l?{duration:.38,ease:[.4,0,.2,1]}:{delay:r?.35:.08,duration:.62,ease:[.22,1,.36,1]},children:n.display})}),n.subtitle&&a.jsx(m.p,{className:["db-ink-subtitle",t?"text-stone-300":"text-stone-600"].join(" "),initial:r?{opacity:0}:d?!1:{opacity:0,y:14},animate:l?{opacity:0,y:-6}:{opacity:1,y:0},transition:l?{duration:.32,delay:.04,ease:[.4,0,.2,1]}:{delay:r?.52:.42,duration:.55,ease:[.22,1,.36,1]},children:n.subtitle}),n.body&&n.body.length>0&&a.jsx(f1,{lines:n.body,onDark:t,variant:"asymmetric",baseDelay:r?.62:.52,exiting:l,exitBaseDelay:.02})]}),a.jsxs(m.div,{className:"db-layout-race-far-lane","aria-hidden":!0,animate:l?{opacity:0}:{opacity:1},transition:{duration:l?.48:.2,ease:[.4,0,.2,1]},children:[a.jsx(j1,{classSuffix:"1",boatIndex:3,isNight:i,isExitingMorph:l,driftDuration:26,baseOpacity:.3,rowBurst:y&&!l,burstPath:(p==null?void 0:p.far1)??null,boatRef:Z}),a.jsx(j1,{classSuffix:"2",boatIndex:2,isNight:i,isExitingMorph:l,driftDuration:34,baseOpacity:.48,rowBurst:y&&!l,burstPath:(p==null?void 0:p.far2)??null,boatRef:A})]}),a.jsx(m.div,{ref:j,className:"db-layout-race-boat",initial:r?{opacity:.75,x:"-18vw",y:"14%",scale:.92}:d?!1:{opacity:0,x:"-28vw",y:"12%"},animate:l?{opacity:.92,x:"108vw",y:"-3%",scale:1.12}:y&&p?{opacity:1,x:p.near,y:0,scale:1}:{opacity:1,x:0,y:0,scale:1},transition:l?{duration:S1,ease:_2,delay:.06}:y&&p?{duration:y1,ease:H1,times:[...q1]}:{delay:r?.12:d?0:.42,duration:r?1.15:1.05,ease:[.22,1,.36,1]},children:a.jsx(L1,{index:1,isNight:i,showLabel:!1,morphLite:l,rowBurst:y&&!l,hitTargetRef:x})}),a.jsx(q2,{hitTargetRef:x,onTap:V,disabled:l,isNight:i}),a.jsx(H2,{active:T&&!l,isNight:i}),l&&a.jsx(m.div,{className:"db-layout-race-warm-glow",style:{background:h2(i)},initial:{opacity:0,scale:.88},animate:{opacity:.85,scale:1.04},transition:{duration:S1*.85,delay:.12,ease:[.32,.72,0,1]},"aria-hidden":!0})]})}const $2={sm:"db-mugwort-mark--sm",md:"db-mugwort-mark--md",lg:"db-mugwort-mark--lg"};function P2({className:n,size:t="md",animate:i=!0}){const e=S(),l=a.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 30 70",fill:"none",role:"img","aria-label":"艾",className:"db-mugwort-mark-svg",children:[a.jsx("path",{d:"M 15 20 C 5 25, 2 45, 12 55 C 10 40, 12 30, 15 20 Z",fill:"#047857",opacity:"0.95"}),a.jsx("path",{d:"M 15 20 C 25 25, 28 45, 18 55 C 20 40, 18 30, 15 20 Z",fill:"#065F46",opacity:"0.9"}),a.jsx("path",{d:"M 15 5 L 8 45 C 8 45, 15 50, 15 65 C 15 50, 22 45, 22 45 L 15 5 Z",fill:"#059669"}),a.jsx("rect",{x:"11",y:"32",width:"8",height:"3",rx:"1.5",fill:"#EF4444"}),a.jsx("path",{d:"M 14 35 Q 11 50, 12 60 M 16 35 Q 19 50, 18 60",stroke:"#EF4444",strokeWidth:"1"})]}),c=["db-mugwort-mark",$2[t],n].filter(Boolean).join(" ");return!i||e?a.jsx("span",{className:c,children:l}):a.jsx(m.span,{className:c,initial:{opacity:0,y:-8,scale:.85},animate:{opacity:1,y:0,scale:1},transition:{delay:.28,duration:.55,ease:[.22,1,.36,1]},children:l})}const W2=`  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1153.44 1086.59" style="vertical-align: middle; max-width: 100%; width: 100%;" width="100%">
   <g>
    <g>
...
`,X2=W2,Y2=V2,U2={sm:"db-treat-svg--sm",md:"db-treat-svg--md",lg:"db-treat-svg--lg"};function G2({raw:n,size:t="md",className:i,label:e}){return a.jsx("span",{className:["db-treat-svg",U2[t],i].filter(Boolean).join(" "),role:"img","aria-label":e,dangerouslySetInnerHTML:{__html:n}})}function J2({className:n,size:t="lg",enterAnimate:i=!0}){const e=S(),[l,c]=s.useState(!1),[d,h]=s.useState(!i||e),r=()=>{c(u=>!u),d||h(!0)},o=e?{initial:!1,animate:{opacity:1},exit:{opacity:0},transition:{duration:.12}}:{initial:{opacity:0,scale:.92,y:8,filter:"blur(5px)"},animate:{opacity:1,scale:1,y:0,filter:"blur(0px)"},exit:{opacity:0,scale:.94,y:-6,filter:"blur(4px)"},transition:{duration:.48,ease:[.22,1,.36,1]}},y=!d&&i&&!e?{initial:{opacity:0,scale:.6,y:10},animate:{opacity:1,scale:1,y:0}}:{};return a.jsx("button",{type:"button",className:["db-zongzi-flip-treat",n].filter(Boolean).join(" "),onClick:u=>{u.stopPropagation(),r()},"aria-label":l?"甜筒变回粽子":"粽子变甜筒","aria-pressed":l,children:a.jsx("span",{className:"db-zongzi-flip-treat-stage",children:a.jsx(W,{mode:"wait",initial:!1,children:a.jsx(m.span,{className:"db-zongzi-flip-treat-inner",...o,...!l&&!d?y:{},onAnimationComplete:()=>{d||h(!0)},children:a.jsx(G2,{raw:l?Y2:X2,size:t,label:l?"甜筒":"粽"})},l?"ice":"zong")})})})}const J={hidden:{opacity:0,x:14},visible:{opacity:1,x:0,transition:{duration:.4,ease:[.22,1,.36,1]}}};function h1({text:n,className:t,hide:i}){return i?null:a.jsx(m.p,{className:["db-festive-vertical-text",t].filter(Boolean).join(" "),variants:J,children:n})}function Q2({beat:n,onDark:t,enterFromMorph:i,isExitingMorph:e=!1,onMorphComplete:l}){var M;const c=S(),h=s.useRef(i&&!c).current,r=s.useRef(!1),o=(M=n.body)==null?void 0:M[n.body.length-1],y=n.body&&n.body.length>1?n.body.slice(0,-1):n.body,u=h?{hidden:{opacity:0,x:32},visible:{opacity:1,x:0,transition:{duration:.52,ease:[.22,1,.36,1],staggerChildren:.04,delayChildren:.05}}}:{hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.07,delayChildren:.1}}},p=s.useCallback(()=>{!e||r.current||(r.current=!0,l==null||l())},[e,l]);s.useEffect(()=>{if(!e){r.current=!1;return}if(c){p();return}const f=window.setTimeout(p,f2),b=window.setTimeout(p,o1+80);return()=>{window.clearTimeout(f),window.clearTimeout(b)}},[e,c,p]);const g=t?"db-ink-display--on-dark":"db-ink-display--on-light";return a.jsxs(l1,{className:"db-layout-festive-vertical",variant:"split",children:[a.jsxs(m.aside,{className:"db-layout-festive-side",initial:h&&!c?{opacity:0,x:16}:!1,animate:e?{opacity:0,x:-16}:{opacity:1,x:0},transition:{duration:e?.36:h?.48:.35,delay:h&&!e?.04:0,ease:[.22,1,.36,1]},children:[a.jsx(P2,{size:"lg",className:"db-festive-side-mugwort",animate:!h&&!e}),!e&&a.jsx(J2,{size:"lg",className:"db-festive-side-zongzi",enterAnimate:!h&&!e})]}),a.jsxs(m.div,{className:"db-layout-festive-columns",variants:u,initial:c?!1:"hidden",animate:e?{opacity:0,x:-28}:"visible",transition:e?{duration:.42,ease:[.38,.02,.18,1]}:void 0,children:[a.jsx(m.div,{className:"db-festive-vcol db-festive-vcol--title",variants:J,children:a.jsxs("h2",{className:["db-festive-title-vertical",g].join(" "),"aria-label":"节物",children:[a.jsx("span",{className:"db-festive-title-char",children:"节"}),a.jsx("span",{className:"db-festive-title-char",children:"物"})]})}),n.subtitle&&a.jsx(m.div,{className:"db-festive-vcol",variants:J,children:a.jsx(h1,{text:n.subtitle,className:t?"text-stone-200/90":"text-stone-700",hide:e})}),y==null?void 0:y.map(f=>a.jsx(m.div,{className:"db-festive-vcol",variants:J,children:a.jsx(h1,{text:f,className:t?"text-stone-200/88":"text-stone-700/95",hide:e})},f)),o&&a.jsx(m.div,{className:"db-festive-vcol db-festive-vcol--bridge",variants:J,children:a.jsx(h1,{text:o,className:t?"text-amber-100/85":"text-emerald-950/85",hide:e})})]})]})}function K2({beat:n,isNight:t}){const i=`db-ambient db-ambient--${n.id}${t?" db-ambient--night":""}`;return a.jsxs("div",{className:i,"aria-hidden":!0,children:[n.id==="prologue"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-ambient-spot db-ambient-spot--a"}),a.jsx("div",{className:"db-ambient-spot db-ambient-spot--b"}),a.jsx("div",{className:"db-ambient-spot db-ambient-spot--c"})]}),n.id==="river"&&a.jsxs(a.Fragment,{children:[a.jsxs("div",{className:"db-ambient-mountains","aria-hidden":!0,children:[a.jsx("div",{className:"db-ambient-mountain db-ambient-mountain--back"}),a.jsx("div",{className:"db-ambient-mountain db-ambient-mountain--mid"}),a.jsx("div",{className:"db-ambient-mountain db-ambient-mountain--front"})]}),a.jsx("div",{className:"db-ambient-mist"}),a.jsx("div",{className:"db-ambient-ripple-band"}),a.jsx("div",{className:"db-ambient-waterline"})]}),n.id==="festive"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-ambient-smoke db-ambient-smoke--1"}),a.jsx("div",{className:"db-ambient-smoke db-ambient-smoke--2"}),a.jsx("div",{className:"db-ambient-leaf db-ambient-leaf--1"}),a.jsx("div",{className:"db-ambient-leaf db-ambient-leaf--2"})]}),n.id==="letter"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-ambient-paper-shimmer"}),a.jsx("div",{className:"db-ambient-ink-wet"})]}),n.id==="finale"&&a.jsx("div",{className:"db-ambient-gold-dust",children:Array.from({length:12},(e,l)=>a.jsx("span",{className:"db-ambient-gold-particle",style:{"--p-i":l}},l))})]})}function n0({isNight:n,isExiting:t,onComplete:i}){const e=S(),l=s.useRef(!1),c=s.useCallback(()=>{!t||l.current||(l.current=!0,i==null||i())},[t,i]);if(s.useEffect(()=>{if(!t){l.current=!1;return}if(e){c();return}const h=window.setTimeout(c,a1+120);return()=>window.clearTimeout(h)},[t,e,c]),!t)return null;const d=G("river",n);return a.jsxs(a.Fragment,{children:[a.jsx(m.div,{className:"db-morph-ink-bloom pointer-events-none absolute inset-0 z-[12]",style:{background:n?"radial-gradient(ellipse 45% 38% at 50% 42%, rgba(2,44,29,0.95) 0%, transparent 72%)":"radial-gradient(ellipse 45% 38% at 50% 42%, rgba(28,25,23,0.88) 0%, transparent 72%)"},initial:{opacity:0,scale:.15},animate:{opacity:1,scale:2.8},transition:{duration:a1/1e3,ease:[.32,.72,0,1]},onAnimationComplete:c,"aria-hidden":!0}),a.jsx(m.div,{className:"db-morph-ink-river pointer-events-none absolute inset-0 z-[11]",style:{background:d},initial:{opacity:0},animate:{opacity:1},transition:{duration:a1/1e3,delay:.22,ease:[.22,1,.36,1]},"aria-hidden":!0})]})}const a0=2.1,t0={"top-left":"db-scroll-egg--top-left","top-right":"db-scroll-egg--top-right","bottom-left":"db-scroll-egg--bottom-left","bottom-right":"db-scroll-egg--bottom-right","mid-left":"db-scroll-egg--mid-left"};function l0({egg:n,theme:t,onDark:i,isNight:e,index:l,hidden:c,onTap:d}){const[h,r]=s.useState(!1),o=S();if(c)return null;const y=n.anchor.includes("right"),u=e||i?"text-amber-100/90":"text-emerald-900";return a.jsxs(m.div,{className:["db-scroll-egg-slot",t0[n.anchor]].join(" "),initial:o?{}:{opacity:0},animate:{opacity:1},transition:{delay:.85+l*.08,duration:.4},children:[a.jsx(m.button,{type:"button",className:["db-scroll-egg",n.hint&&"db-scroll-egg--hint",t.egg,t.eggHover,"border-0 bg-transparent font-serif"].join(" "),onClick:p=>{p.stopPropagation(),n.reveal&&(r(g=>!g),d==null||d())},"aria-expanded":h,"aria-label":n.reveal?`彩蛋：${n.text}`:n.text,children:n.text}),a.jsx(W,{children:h&&n.reveal&&a.jsx(m.p,{initial:{opacity:0,x:y?8:-8,filter:"blur(4px)"},animate:{opacity:1,x:0,filter:"blur(0px)"},exit:{opacity:0,x:y?6:-6},transition:{duration:.35},className:["db-scroll-egg-reveal",n.hint&&"db-scroll-egg-reveal--hint",u].join(" "),children:n.reveal})})]})}function e0({beat:n,isNight:t,onDark:i,morphPhase:e,onMorphComplete:l,enterFromMorph:c,letterEnterFromMorph:d}){const h=S(),r=e==="morph-jiang"&&n.id==="river",o=e==="morph-boat"&&n.id==="race",y=e==="morph-zongzi-seal"&&n.id==="festive";if(n.layout==="river-glyph")return a.jsx(w2,{beat:n,onDark:i,isNight:t,isExitingMorph:r,onMorphComplete:l});if(n.layout==="race-diagonal")return a.jsx(z2,{beat:n,onDark:i,isNight:t,enterFromMorph:c==="morph-jiang",isExitingMorph:o,onMorphComplete:l});if(n.layout==="festive-split")return a.jsx(Q2,{beat:n,onDark:i,enterFromMorph:c==="morph-boat",isExitingMorph:y,onMorphComplete:l});const u=a.jsxs(l1,{className:["db-scene-layout--center",n.bodyVariant==="letter"?"db-scroll-content--letter":""].filter(Boolean).join(" "),variant:"stack",children:[a.jsx(c2,{text:n.display,mode:n.displayMode,onDark:i}),n.subtitle&&a.jsx(s2,{text:n.subtitle,onDark:i}),n.body&&n.body.length>0&&a.jsx(f1,{lines:n.body,onDark:i,variant:n.bodyVariant??"center"})]});return n.id==="letter"&&d?a.jsx(m.div,{className:"db-scene-layout-letter-enter",initial:h?!1:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{duration:.48,delay:.05,ease:[.22,1,.36,1]},children:u}):u}function i0({beat:n,isNight:t,theme:i,introComplete:e=!0,onUnrollComplete:l,morphPhase:c,onMorphComplete:d,enterFromMorph:h,onEggTap:r}){const o=S(),y=R1(n.material,t),u=n.material==="dawn"&&!t,p=G(n.material,t),g=n.layout!=="center",M=n.id==="prologue"&&!e&&!o,f=c==="morph-jiang"||c==="morph-boat"||c==="morph-ink"||c==="morph-zongzi-seal",b=c==="morph-ink"&&n.id==="prologue",j=s.useRef(h==="morph-zongzi-seal"&&!o).current,Z=c==="morph-jiang"&&n.id==="river"?G("race",t):c==="morph-boat"&&n.id==="race"?G("festive",t):c==="morph-zongzi-seal"&&n.id==="festive"?G("paper",t):null;return s.useEffect(()=>{if(!M||!l)return;const A=window.setTimeout(l,a0*1e3);return()=>window.clearTimeout(A)},[M,l]),a.jsxs("div",{className:["db-scroll-scene",n.material==="paper"?"db-scroll-scene--paper":"",g?"db-scroll-scene--layout":"",M?"db-scroll-scene--unrolling":"",f?"db-scroll-scene--morphing":"",u?"db-scroll-scene--dawn-day":"",n.id==="race"?"db-scroll-scene--race":"",n.id==="festive"?"db-scroll-scene--festive":""].join(" "),style:{background:p},role:"group","aria-roledescription":"slide","aria-label":`${n.display}${n.subtitle?`，${n.subtitle}`:""}`,children:[M&&a.jsx("div",{className:"db-scroll-unroll-edge","aria-hidden":!0}),a.jsx(K2,{beat:n,isNight:t}),a.jsx(n0,{isNight:t,isExiting:b,onComplete:d}),Z&&a.jsx("div",{className:["db-morph-bg-crossfade pointer-events-none absolute inset-0 z-[1]",c==="morph-boat"?"db-morph-bg-crossfade--boat":"",c==="morph-jiang"?"db-morph-bg-crossfade--jiang":"",c==="morph-zongzi-seal"?"db-morph-bg-crossfade--letter":""].filter(Boolean).join(" "),style:{background:Z,animationDuration:c==="morph-boat"||c==="morph-jiang"||c==="morph-zongzi-seal"?void 0:`${K}ms`},"aria-hidden":!0}),a.jsx(d2,{chapter:n.chapter,sceneLabel:n.sceneLabel,onDark:y}),t&&n.material==="dawn"&&a.jsx("div",{className:"pointer-events-none absolute inset-x-0 top-0 h-1/2 opacity-60",style:{background:"radial-gradient(circle at 50% 0%, rgba(252,211,77,0.12) 0%, transparent 65%)"},"aria-hidden":!0}),!t&&n.material==="dawn"&&a.jsx("div",{className:"pointer-events-none absolute inset-x-0 top-0 h-2/3",style:{background:"radial-gradient(circle at 50% 0%, rgba(252,211,77,0.22) 0%, transparent 70%)"},"aria-hidden":!0}),n.material==="river"&&n.layout==="center"&&a.jsx(m.svg,{className:"pointer-events-none absolute inset-x-0 top-[16%] h-28 w-full opacity-25",viewBox:"0 0 400 40",preserveAspectRatio:"none","aria-hidden":!0,initial:o?{}:{x:"-4%"},animate:{x:"4%"},transition:{duration:8,repeat:1/0,repeatType:"reverse",ease:"easeInOut"},children:a.jsx("path",{d:"M0 25 Q100 8, 200 22 T400 18 L400 40 L0 40 Z",fill:t?"#065f46":"#98B5A8"})}),n.material==="paper"&&a.jsxs(a.Fragment,{children:[a.jsx("div",{className:"db-scroll-paper-texture pointer-events-none absolute inset-[8%] rounded-sm opacity-90","aria-hidden":!0}),a.jsx("div",{className:"db-scroll-paper-margin pointer-events-none absolute inset-y-[10%] left-[10%] w-px bg-stone-400/25","aria-hidden":!0})]}),a.jsx(e0,{beat:n,isNight:t,onDark:y,morphPhase:c,onMorphComplete:d,enterFromMorph:h,letterEnterFromMorph:j}),n.eggs.map((A,x)=>a.jsx(l0,{egg:A,theme:i,onDark:y,isNight:t,index:x,hidden:f,onTap:r},A.id))]})}const c0=m.create(i0);function s0({visible:n,onDark:t=!0}){const i=S();return n?a.jsxs("div",{className:`db-scroll-hint ${t?"text-stone-300":"text-stone-600"}`,"aria-hidden":!0,children:[a.jsx(m.div,{className:"db-scroll-hint-chevron",animate:i?{}:{y:[0,6,0],opacity:[.5,1,.5]},transition:{duration:1.6,repeat:1/0,ease:"easeInOut"}}),a.jsx("span",{children:"向上滑动 · 滚轮展卷"})]}):null}function d0({index:n,visited:t,onSelect:i}){return a.jsx("nav",{className:"db-scroll-seals","aria-label":"长卷分幕",children:Q.map((e,l)=>{const c=l===n,d=t.has(l)&&!c;return a.jsx("button",{type:"button","aria-label":`${e.chapter} · ${e.sceneLabel}`,"aria-current":c?"step":void 0,onClick:()=>i(l),className:["db-scroll-seal",c?"db-scroll-seal--active":"",d?"db-scroll-seal--visited":""].filter(Boolean).join(" "),children:a.jsx("span",{className:"db-scroll-seal-face","aria-hidden":!0,children:e.chapter})},e.id)})})}function h0({pulse:n,direction:t,isNight:i}){if(S()||n===0)return null;const l=i?"linear-gradient(180deg, rgba(2,44,29,0) 0%, rgba(2,44,29,0.92) 45%, rgba(1,6,4,0.98) 100%)":"linear-gradient(180deg, rgba(74,100,88,0) 0%, rgba(42,66,56,0.75) 40%, rgba(2,44,29,0.88) 100%)";return a.jsx(W,{mode:"wait",children:a.jsx(m.div,{className:"db-transition-curtain",style:{background:l,transformOrigin:t>0?"50% 100%":"50% 0%"},initial:{scaleY:0,opacity:.6},animate:{scaleY:[0,1.05,0],opacity:[.5,.92,0]},exit:{opacity:0},transition:{duration:.78,ease:[.76,0,.24,1],times:[0,.42,1]},"aria-hidden":!0},n)})}const p0={enter:n=>({opacity:0,y:n>0?"14%":"-14%",scale:.92,filter:"blur(12px)"}),center:{opacity:1,y:0,scale:1,filter:"blur(0px)"},exit:n=>({opacity:0,y:n>0?"-22%":"22%",scale:1.04,filter:"blur(14px)"})},r0={duration:.72,ease:[.32,.72,0,1]},f0=42,o0=52,k1=820,y0=Math.max(...o2)+80,u0=new Set(["morph-ink","morph-jiang","morph-boat","morph-zongzi-seal"]);function M0(n){return!!n&&u0.has(n)}function Z0({isNight:n,theme:t,onFirstAdvance:i,soundEnabled:e=!0}){const[l,c]=s.useState(0),[d,h]=s.useState(1),[r,o]=s.useState(!0),[y,u]=s.useState(0),[p,g]=s.useState(!1),[M,f]=s.useState(null),[b,k]=s.useState(null),[j,Z]=s.useState(null),[A,x]=s.useState(()=>new Set([0])),v=s.useRef(0),T=s.useRef(null),I=s.useRef(null),N=s.useRef(0),D=s.useRef(null),V=s.useRef(null),L=s.useRef(!1),z=s.useRef(0),X=S();s.useEffect(()=>{R.setMuted(!e)},[e]),s.useEffect(()=>{X&&g(!0)},[X]),s.useEffect(()=>{T.current=b,I.current=M},[b,M]),s.useEffect(()=>{x(w=>{const F=new Set(w);for(let H=0;H<=l;H++)F.add(H);return F});const C=z.current;l!==C&&l===4&&l>C&&R.playLetterOpen(),z.current=l},[l]),s.useEffect(()=>{if(!p)return;R.ensureReady();const C=()=>R.ensureReady();return window.addEventListener("pointerdown",C,{once:!0}),()=>window.removeEventListener("pointerdown",C)},[p]);const u1=s.useCallback(C=>{switch(C){case"morph-ink":R.playMorphInk();break;case"morph-jiang":R.playMorphWater();break;case"morph-boat":R.playMorphDrum();break;case"morph-zongzi-seal":R.playMorphSeal();break}},[]),Y=s.useCallback(C=>{var _;const w=Math.max(0,Math.min(a2-1,C));if(w===l||!p||M||Date.now()<v.current)return;const F=w>l?1:-1;if(h(F),F>0){const B=t2(l,w);if(B){f(B),k(w),u1(B),v.current=Date.now()+y0,N.current=0;return}}Z(null),(F>0&&((_=Q[l])==null?void 0:_.forwardTransition)==="light-curtain"||F<0)&&u(B=>B+1),c(w),v.current=Date.now()+k1,N.current=0,!L.current&&w>0&&(L.current=!0,o(!1),i==null||i())},[l,p,M,i,u1]),_1=s.useCallback(()=>{const C=T.current;if(C==null){f(null);return}const w=I.current;Z(w),c(C),k(null),f(null),v.current=Date.now()+k1,!L.current&&C>0&&(L.current=!0,o(!1),i==null||i()),requestAnimationFrame(()=>Z(null))},[i]),$=s.useCallback(()=>Y(l+1),[Y,l]),P=s.useCallback(()=>Y(l-1),[Y,l]),B1=s.useCallback(()=>{g(!0),R.playUnroll()},[]),O1=s.useCallback(()=>{R.playEggTap()},[]);s.useEffect(()=>{const C=V.current;if(!C)return;const w=F=>{F.preventDefault(),!(!p||M)&&(Date.now()<v.current||(N.current+=F.deltaY,!(Math.abs(N.current)<f0)&&(N.current>0?$():P(),N.current=0)))};return C.addEventListener("wheel",w,{passive:!1}),()=>C.removeEventListener("wheel",w)},[$,P,p,M]),s.useEffect(()=>{const C=V.current;if(!C)return;const w=H=>{var _;D.current=((_=H.touches[0])==null?void 0:_.clientY)??null},F=H=>{var m1;const _=D.current;if(D.current=null,_==null||!p||M)return;const B=(m1=H.changedTouches[0])==null?void 0:m1.clientY;if(B==null)return;const Z1=B-_;Math.abs(Z1)<o0||(Z1<0?$():P())};return C.addEventListener("touchstart",w,{passive:!0}),C.addEventListener("touchend",F,{passive:!0}),()=>{C.removeEventListener("touchstart",w),C.removeEventListener("touchend",F)}},[$,P,p,M]),s.useEffect(()=>{const C=w=>{!p||M||(w.key==="ArrowDown"||w.key==="PageDown"?(w.preventDefault(),$()):(w.key==="ArrowUp"||w.key==="PageUp")&&(w.preventDefault(),P()))};return window.addEventListener("keydown",C),()=>window.removeEventListener("keydown",C)},[$,P,p,M]),s.useEffect(()=>()=>R.stopAmbient(),[]);const e1=Q[l],E1=R1(e1.material,n),M1=M0(M),I1=X?{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.18}}:M1||(j==="morph-jiang"||j==="morph-boat"||j==="morph-ink"||j==="morph-zongzi-seal")?{initial:!1,animate:{opacity:1},exit:{opacity:1},transition:{duration:0}}:{custom:d,variants:p0,initial:"enter",animate:"center",exit:"exit",transition:r0};return a.jsxs("div",{ref:V,className:"relative h-full w-full overflow-hidden",tabIndex:0,"aria-live":"polite",children:[!M1&&a.jsx(h0,{pulse:y,direction:d,isNight:n}),a.jsx(W,{mode:"wait",custom:d,children:a.jsx(c0,{beat:e1,direction:d,isNight:n,theme:t,introComplete:p,onUnrollComplete:B1,morphPhase:M,onMorphComplete:_1,enterFromMorph:j,onEggTap:O1,...I1},e1.id)}),a.jsx(s0,{visible:r&&l===0&&p,onDark:E1}),a.jsx(d0,{index:l,visited:A,onSelect:Y})]})}const m0=""+new URL("ambient-BBYjlx1c.mp3",import.meta.url).href;function b0(){R.setAmbientSrc(m0)}function x0({theme:n,onBackToArchive:t,onBackToCabinet:i}){const e=!!(n!=null&&n.isNight),l=n2(e),[c,d]=s.useState(!0);return s.useEffect(()=>(V1(X1("festival-2026-DragonBoat")),b0(),()=>{R.dispose()}),[]),a.jsxs(Y1,{id:"dragon-boat-scroll-root",className:"relative h-full min-h-0 overflow-hidden font-serif select-none [&_.viewport-main]:overflow-hidden [&_.viewport-main-inner]:h-full [&_.viewport-main-inner]:min-h-0",children:[a.jsx("div",{className:"pointer-events-none absolute inset-0 z-0",style:{background:e?"#0a2018":"#FCFBEB"},"aria-hidden":!0}),a.jsx("div",{className:"pointer-events-none absolute inset-x-0 top-0 z-[1] h-48 opacity-80",style:{background:l.sunAura},"aria-hidden":!0}),a.jsxs("header",{className:"pointer-events-auto absolute inset-x-0 top-0 z-30 flex items-center justify-between px-3 pb-1 pt-[max(0.5rem,env(safe-area-inset-top))] md:px-4",children:[a.jsx("div",{className:"flex items-center gap-2",children:i&&a.jsxs("button",{type:"button",onClick:i,className:`flex cursor-pointer items-center gap-1.5 rounded-full border px-3 py-1.5 font-serif text-xs font-bold transition-all active:scale-95 ${l.headerBtn}`,children:[a.jsx(U1,{className:"h-3.5 w-3.5 text-emerald-400"}),a.jsx("span",{children:"返回展柜"})]})}),a.jsxs("div",{className:"flex items-center",children:[t&&a.jsxs("button",{type:"button",onClick:t,className:"flex cursor-pointer items-center gap-1.5 rounded-full border border-emerald-700/40 bg-emerald-950/30 px-3 py-1.5 font-serif text-xs text-stone-300 transition-all hover:bg-emerald-900/50 hover:text-emerald-300 active:scale-95",children:[a.jsx(K1,{className:"h-3.5 w-3.5 text-emerald-400"}),a.jsx("span",{children:"节日风物志"})]}),a.jsx("button",{type:"button",onClick:()=>d(h=>!h),className:`ml-2 flex cursor-pointer items-center justify-center rounded-full border p-2 transition-all active:scale-95 ${l.headerBtn}`,"aria-label":c?"关闭端午页音效":"开启端午页音效",title:c?"关闭音效":"开启音效",children:c?a.jsx(G1,{className:"h-3.5 w-3.5 text-emerald-400"}):a.jsx(J1,{className:"h-3.5 w-3.5 text-stone-400"})})]})]}),a.jsx("main",{className:"relative z-10 h-full min-h-0 w-full flex-1",children:a.jsx(Z0,{isNight:e,theme:l,soundEnabled:c})})]})}export{x0 as DragonBoatScroll};
